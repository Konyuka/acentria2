var vidyardEmbed = function(e) {
    ...
    ,
    n.p = "https://play.vidyard.com/embed/",
    n(n.s = 6)
}([function(e, t) {
    var n;
    n = function() {
...
, function(e, t, n) {
    ...
    var i, o, a, u = n(14), c = n(13), s = function(e) {
    ...
    function p() {
        ...
        a = [],
        i && i.setAttribute("role", "main"),
        o.dispatchEvent(new u("screenreaderUntrap",{
            bubbles: !0
        })),
        o = null)
    }
    ...
    e.exports = {
        trap: function(e, t) {
            ...
            !0 === n.useHiddenProperty && (v = v.filter(s),
            y = y.filter(s)),
            (a = [l(o, n.useHiddenProperty)].concat(f.map(function(e) {
...
, function(e, t, n) {
    "use strict";
    n.r(t);
    var r, i, o, a = n(5), u = function(e) {
        return "function" == typeof e
    }, c = (i = (void 0 === r ? window : r).Promise) && i.all && i.race && i.resolve && i.reject && u(i) && u(i.all) && u(i.race) && u(i.resolve) && u(i.reject) ? window.Promise : a.a, s = function(e, t, n, r) {
    ...
    }, T = "4.3.15", j = /vidyard\.com\/embed\/v4/, L = .5, A = 319, P = {
    ...
    }, V = P.setPlaybackURL, U = P.getPlaybackURL, R = function() {
        return "https://" + U() + "/v4/"
    }, M = function() {
        function e(e) {
            var t = this;
            ...
            "inline" !== this.type && "lightbox" !== this.type && (v("Invalid Vidyard player embed type, defaulting to inline.", "warn"),
            this.type = "inline"),
            this.v = T,
            this.disable_popouts = 1,
            this.custom_id = this.custom_id || I("vycustom_id"),
            this.vyemail = this.vyemail || I("vyemail"),
            this.vysfid = this.vysfid || I("vysfid"),
            this.vyetoken = this.vyetoken || I("vyetoken");
            var r = I("vyac")
              , i = I("vyplayer");
        ...
        return e.prototype.toQueryString = function() {
            var e, t = "?";
            for (e in this)
                this.hasOwnProperty(e) && "height" !== e && "uuid" !== e && "width" !== e && void 0 !== this[e] && (t += "?" !== t ? "&" : "",
    ...
    function F(e) {
        ...
        for (var t = 0, n = e; t < n.length; t++) {
            ...
            o && (-1 === f(a, window.VidyardV4.preloadLinks) && (q(o, a),
            window.VidyardV4.preloadLinks.push(a)))
        }
    }
    function q(e, t) {
        var n = document.createElement("link");
        return n.rel = "prefetch",
    ...
    var B = function(e, t, n) {
        if (t && n)
            if (window.postMessage && n.contentWindow)
                n.contentWindow.postMessage(JSON.stringify(e), t);
            else {
                if ("associateVisitor" !== e.event)
                    return;
    ...
    var z = ["pardot", "hubspotutk", "_mkto_trk", "vy_dreamforce", "eloqua"]
      , W = ["pardot", "hubspot", "marketo", "dreamforce", "eloqua"];
    var H = function() {
      ...
      , Q = x();
    Q && ($.info("vidyardEmbed V" + T + " loaded from " + Q.src),
    $.info("data-playbackurl=" + Q.getAttribute("data-playbackurl"))),
    $.info("userAgent " + window.navigator.userAgent),
    $.info("cookies " + navigator.cookieEnabled),
    window.performance && window.performance.timing && window.performance.timing.navigationStart && $.info("Script load time " + (Date.now() - window.performance.timing.navigationStart));
    var K = {
        logger: $,
        getPlaybackURL: U,
        setPlaybackURL: V,
    ...
    var X, Z = function(e, t) {
        ...
        "inline" === e.type ? '<div class="vidyard-inner-container-' + e.uuid + '" style="position: absolute;height: 100%; width: 100%; ' + (t.maxWidth ? "max-width: " + t.maxWidth + "px; " : "") + (t.maxHeight ? "max-height: " + t.maxHeight + "px; " : "") + '"> ' + n + "</div> " : n) + "</div>"
    }, Y = function(e) {
        var t = document.createElement("script");
        return t.type = "application/ld+json",
        ...
        return new c(function(n, r) {
            var i = encodeURIComponent(t)
              , o = "" + R() + e + "/contact/" + i + "/marketoContact.js";
            oe({
                error: r,
                success: n,
                url: o,
        ...
        var t = e.url
          ...
          , a = function(e) {
            ...
            return i.type = "application/javascript",
            i.onerror = t,
            i.src = n + "?callback=window.VidyardV4.jsonp." + r + ".done",
            i.setAttribute("data-playbackurl", U()),
        ...
        if (!e)
            return c.reject(new Error(ae.errors.placeholder));
        var t = k(e)
          , n = t.width
          , r = t.height
        ...
        var i = function() {
            return n.placeholder.src !== "//" + U() + "/" + n.uuid + ".jpg" ? (e = n.uuid,
            t = document.createElement("img"),
            t.setAttribute("data-uuid", e),
            t.src = "//" + U() + "/" + e + ".jpg",
            ce(t)).then(h).catch(function() {
                return !1
            }) : c.resolve(!1);
            var e, t
        }
        ...
        c.race([u, l]).then(function() {
            ...
            N(n.placeholder, "inserted", !0),
            e.appendChild(n.placeholder),
            a.parentElement.parentElement.style.position = "relative",
            a.style.opacity = "1"
        }),
        u.then(function() {
            n.placeholder.style.display = "none",
            a.parentElement.parentElement.style.backgroundColor = "transparent"
        }),
        ...
        r("getStyle sent"),
        ee(n.uuid).then(function(e) {
            r("getStyle received: " + JSON.stringify(e)),
            1 === e.pl && "0" !== t.playlist_always_open || "1" === t.playlist_always_open ? (n.iframe.parentElement.setAttribute("data-pl", "true"),
            s("resize", "onresize", d),
            d()) : n.iframe.parentElement.setAttribute("data-pl", "false")
        }).catch(function(e) {
        ...
        for (var t = 0, n = Array.from(e.children); t < n.length; t++) {
            var r = n[t];
            r.hasAttribute("aria-hidden") && r.setAttribute("data-vy-keep-hidden", r.getAttribute("aria-hidden")),
        ...
        for (var t = 0, n = Array.from(e.children); t < n.length; t++) {
            var r = n[t];
            r.getAttribute("data-vy-keep-hidden") ? r.setAttribute("aria-hidden", r.getAttribute("data-vy-keep-hidden")) : r.removeAttribute("aria-hidden"),
            r.removeAttribute("data-vy-keep-hidden")
        }
    }, pe = {
        ios: function() {
    ...
    , ge = function(e) {
            ...
            return e.push.apply(e, n ? function e(t) {
                for (var n = t.length, r = 0; r < n; r += 1)
                    for (var i = function(n) {
                        ...
                        var a = i(o);
                        if ("object" === (void 0 === a ? "undefined" : me(a)))
                            return a.v
                    }
                return t
            }(he(function e(t) {
                return t.parentNode ? e(t.parentNode) : t
            }(t).querySelectorAll('[data-focus-lock="' + n + '"]:not([data-focus-lock-disabled="disabled"])'))) : [t]),
            e
        }, [])
    }, be = function(e) {
        ...
        return !(!t || t.dataset && t.dataset.focusGuard) && ge(e).reduce(function(e, n) {
            return e || n.contains(t) || (r = he(n.querySelectorAll("iframe")),
            i = be,
            !!r.filter(function(e) {
                return e === i
            })[0]);
    ...
    }, Ee = ["button:enabled:not([readonly])", "select:enabled:not([readonly])", "textarea:enabled:not([readonly])", "input:enabled:not([readonly])", "a[href]", "area[href]", "iframe", "object", "embed", "[tabindex]", "[contenteditable]", "[autofocus]"], _e = Ee.join(","), Oe = _e + ", [data-focus-guard]", Ce = function(e, t) {
        return e.reduce(function(e, n) {
            return e.concat(he(n.querySelectorAll(t ? Oe : _e)), n.parentNode ? he(n.parentNode.querySelectorAll(Ee.join(","))).filter(function(e) {
                return e === n
            }) : [])
        }, [])
    }, Ie = function e(t) {
        ...
        for (var n = Ie(e), r = Ie(t), i = 0; i < n.length; i += 1) {
            var o = n[i];
            if (r.indexOf(o) >= 0)
                return o
        }
        ...
        return ke(Ne(Ce(e, t)), !0, t)
    }, je = function(e) {
        return Ne((t = e.querySelectorAll("[data-autofocus-inside]"),
        he(t).map(function(e) {
            return Ce([e])
        }).reduce(function(e, t) {
            return e.concat(t)
        ...
        return t.filter(Le).filter(function(t) {
            return t.name === e.name
        }).filter(function(e) {
            return e.checked
        })[0] || e
    }, Pe = function(e, t) {
        return e.length > 1 && Le(e[t]) && e[t].name ? e.indexOf(Ae(e[t], e)) : t
    }, Ve = function(e) {
        return e[0] && e.length > 1 && Le(e[0]) && e[0].name ? Ae(e[0], e) : e[0]
    }, Ue = function(e) {
        ...
        var n = document && document.activeElement
          , r = ge(e).filter(Re)
          , i = Me(n || e, e, r)
          , o = Te(r).filter(function(e) {
            var t = e.node;
            return Re(t)
        });
        if (o[0] || (o = (a = r,
        ke(Ne(Ce(a)), !1)).filter(function(e) {
            var t = e.node;
            return Re(t)
        }))[0]) {
            var a, u, c, s, l, d = Te([i]).map(function(e) {
                return e.node
            }), f = (u = d,
            c = o,
            s = new Map,
            ...
            u.map(function(e) {
                return s.get(e)
            }).filter(Boolean)), p = f.map(function(e) {
                return e.node
        ...
        t.filter(function(e) {
            return e
        }).slice(-1)[0])) && (e && e.preventDefault(),
        !0);
        var t
    }, Qe = {
        on: function(e) {
            0 === Je.length && document.addEventListener("focusin", $e),
            Je.indexOf(e) < 0 && (Je.push(e),
            $e())
        },
        off: function(e) {
            ...
            $e(),
            0 === Je.length && document.removeEventListener("focusin", $e)
        }
    }, Ke = n(1), Xe = n.n(Ke);
    function Ze(e, t, n) {
        var r = function(e) {
            ...
            var i = n.getElementsByTagName("iframe")[0]
              , o = i.parentNode;
            return o.style.position = "static",
          ...
          , i = function(e) {
            var t = document.createElement("div")
              ...
              , o = function() {
                ...
                e.className = "vidyard-close-container",
                e.setAttribute("aria-label", "Close Player"),
                e.setAttribute("role", "button"),
                e.setAttribute("tabindex", "0"),
                t.className = "vidyard-close-x",
                document.documentMode < 9 && (t.className += " simple-close",
                t.innerHTML = "&times;");
            ...
            t.id = "vidyard-overlay",
            t.setAttribute("aria-hidden", "true"),
            t.style.display = "block",
            n.id = "vidyard-content-fixed",
            n.setAttribute("aria-label", "media player lightbox"),
            n.setAttribute("role", "dialog"),
            n.style.display = "block",
            r.id = "vidyard-popbox",
            i.id = "vidyard-overlay-wrapper",
        ...
        return a.id = "vidyard-focusable-element",
        a.tabIndex = 0,
        ...
        Qe.on(i.overlayWrapper),
        Xe.a.trap(i.overlayWrapper),
        setTimeout(function() {
    ...
    function et(e) {
        ...
        e.player.showLightbox = function() {
            ...
            function(e) {
                ...
                e.player.on("metadata", function t(n) {
                    var r = n[0];
                    e.player.iframe.title = r.name,
                    e.player.off("metadata", t)
                });
                var n = e.player.uuid
                  ...
                  , i = function(e, t, n) {
                    return g(function() {
                        ...
                        tt(),
                        Ye.parentEsc = s("keydown", "onkeydown", w(function() {
                            return nt(n)
                        }), document)
                    })
                }(r, 0, e.player)
                ...
                Ye.iframeLoaded = s("load", "onload", i, t.container.iframe),
                Ye.messageHandler = s("message", "onmessage", D(function(t) {
                    var n, r;
                    i(),
                    o(),
                    n = t,
                    r = e.player,
                    "keyPressed" === n.event && 27 === n.params && nt(r)
                }), window),
                Ye.overlayClick = s("click", "onclick", function() {
                    return nt(e.player)
                }, t.lightbox.overlayWrapper),
                Ye.fixedClick = s("click", "onclick", function() {
                    return nt(e.player)
                }, t.lightbox.contentFixed),
                Ye.closeKeyPress = s("keydown", "onkeydown", b(function() {
                    return nt(e.player)
                }), t.lightbox.closeContainer),
                Ye.responsivePlayerSize = s("resize", "onresize", tt, window)
            }({
        ...
        ,
        s("click", "onclick", e.player.showLightbox, t),
        s("keydown", "onkeydown", b(function(t) {
            t.preventDefault(),
    ...
    function nt(e) {
        var t, n, r, i, o, a;
        n = document.getElementById("vidyard-content-fixed"),
        r = document.getElementById("vidyard-focusable-element"),
        i = document.getElementById("vidyard-overlay"),
        o = document.getElementById("vidyard-overlay-wrapper"),
        a = document.getElementById("vidyard-popbox"),
        n && i && o && a && (t && Object.keys(t).forEach(function(e) {
            (0,
            t[e])()
        }),
    ...
    ;
    function it(e) {
        if (!e || "string" != typeof e || e.length < 20)
            throw new Error("Invalid UUID given");
        var t = $.setLevel(e)
          , n = "https://" + U() + "/player/" + e + ".json?pomo=0&pomo_reason=fetchMetaData";
        return t("fetching metadata"),
        O({
            endpoint: n
        }).then(JSON.parse).then(function(n) {
            return t("metadata successfully fetched"),
            rt({
                uuid: e
            }, n.payload.vyContext.metadata)
        }).catch(function(e) {
            throw t("failed to fetch metadata, " + e),
            new Error("Error parsing player metadata, make sure the UUID is correct")
        })
    }
    var ot = function(e) {
        var t = e.dataParams
        ...
        }("https://" + U() + "/" + o.uuid + ".jpg", o, a),
        i.insertAdjacentHTML("afterbegin", u),
        it(o.uuid).then(function(e) {
        ...
        ee(n.uuid).then(function(e) {
            ...
            function(e, t) {
                if (1 === e.pb) {
                    ...
                    1 === n.length && (n[0].style.display = "block",
      ...
      , ut = function(e, t, n) {
        if (void 0 === n && (n = !1),
        n || t && t.hasBacklink && !at.test(document.location.host)) {
            var r = document.createElement("a")
              , i = document.createElement("span")
              , o = document.createElement("img");
            o.src = "https://cdn.vidyard.com/client-logos/vidyard.png",
            o.id = "backlink-icon",
            o.alt = "Vidyard Logo",
            i.id = "backlink-text",
            i.textContent = "Powered by Vidyard",
            r.id = "backlink",
            r.appendChild(o),
            r.appendChild(i),
            r.href = t.backlinkURL,
            r.rel = "nofollow",
            r.target = "_blank",
            r.setAttribute("aria-label", "Link to Vidyard"),
            r.dataset.testid = "backlink",
            s("click", "onclick", function() {
                var t = {
                    data: {
    ...
    var ct = function(e, t) {
        ...
        var r = n.style;
        return r.margin = "auto",
        r.width = "100%",
        r.height = "auto",
        r.overflow = "hidden",
        r.display = "block",
        "inline" === t.type && (r.maxWidth = t.width ? t.width + "px" : "",
      ...
      , lt = function() {
        function e(e, t, n) {
            ...
            s("message", "onmessage", this._onMessageEventHandler)
        }
        return e.prototype.on = function(e, t) {
            var n = this;
            if ("ready" !== e || !this.ready())
                return void 0 === this._callbackStore[e] ? (this._callbackStore[e] = [t],
                void v("The event name: " + e + " is not supported, your handler was setup regardless", "warn")) : void this._callbackStore[e].push(t);
            setTimeout(function() {
            ...
            if (void 0 !== e) {
                if (this._callbackStore[e])
                    if (t) {
                        ...
                        this._callbackStore[e] = []
            } else
                for (var r in this._callbackStore)
                    this._callbackStore.hasOwnProperty(r) && (this._callbackStore[r] = [])
        }
        ,
        ...
        e.prototype.playChapter = function(e) {
            v("playChapter() is deprecated. We recommend to use playVideoAtIndex() instead."),
            this.playVideoAtIndex(e)
        }
        ,
        ...
        e.prototype.addEvent = function(e) {
            var t = e.start
              ...
              , u = e.eventId;
            if (u) {
                a >= 0 && v("Parameter chapterIndex is deprecated. We recommend to use videoIndex instead.");
                var c = 0;
                c = a || c,
                c = o || c,
                this._message({
        ...
        e.prototype.getCurrentChapter = function() {
            return v("getCurrentChapter() is deprecated. We recommend to use getCurrentVideoIndex() instead."),
        ...
        e.prototype.toggleFullscreen = function() {
            var e = this
              , t = function() {
                for (var e = [["requestFullscreen", "exitFullscreen", "fullscreenElement", "fullscreenchange"], ["webkitRequestFullscreen", "webkitExitFullscreen", "webkitFullscreenElement", "webkitfullscreenchange"], ["mozRequestFullScreen", "mozCancelFullScreen", "mozFullScreenElement", "mozfullscreenchange"], ["msRequestFullscreen", "msExitFullscreen", "msFullscreenElement", "MSFullscreenChange"]], t = [], n = {}, r = 0, i = e; r < i.length; r++) {
                    var o = i[r];
                    if (o[1]in document) {
                        t = o;
                        break
        ...
        e.prototype._updateStatus = function(e) {
            if ("object" == typeof e.status && (this.status = e.status),
            "object" == typeof e.metadata && (this.metadata = e.metadata,
            this.trigger("metadata", e.metadata)),
            this.status) {
      ...
      , dt = function(e) {
        ...
        void 0 !== i) {
            if ("true" === r.rendered)
                return o("Already rendered"),
                y(n, function(t) {
                    return t.placeholder === e
                });
            var a = ct(i, r)
              , u = new lt(a,i);
            return e.setAttribute("data-rendered", "true"),
            ...
            function(e) {
                ...
                r && (n("getMarketoLead sent"),
                re(e.uuid, r).then(_).then(function(r) {
    ...
    function vt(e, t) {
        ...
        }(e, t, pt[e.uuid].callback, pt[e.uuid].thresholds.slice())
    }
    function yt(e, t) {
        var n = e.getCurrentVideoIndex()
          , r = function(e, t) {
            if ("object" == typeof pt[e.uuid])
                return "object" != typeof ht[e.uuid][t] && vt(e, t),
                ht[e.uuid][t]
        }(e, n);
        if (void 0 !== r && "object" == typeof r.player.metadata && 0 !== r.thresholds.length) {
            var i = t - r.lastTimeUpdate;
            if (r.lastTimeUpdate = t,
            !(i <= 0 || i > 1)) {
                t >= 1 && (r.partOfVideoWatched[Math.floor(t)] = 1),
                r.timeWatched = Object.keys(r.partOfVideoWatched).length;
                for (var o = r.player.metadata.chapters_attributes[n].video_attributes.length_in_milliseconds, a = Math.floor(o / 1e3), u = r.timeWatched / a * 100; u >= r.thresholds[r.thresholds.length - 1]; )
                    r.callback({
                        chapter: n,
    ...
    function mt(e, t, n) {
        !function(e, t, n) {
            "object" != typeof ht[e.uuid] && (ht[e.uuid] = {}),
            pt[e.uuid] = {
                callback: t,
    ...
    var wt = {
        ...
        api: {
            GDPR: {
                ...
                hasConsentOnReady: function(e) {
                    ...
                    if (0 === r.length)
                        return e(!1);
                    if (void 0 !== n._readyConsent)
                        return e(n._readyConsent);
                    for (var i = 0, o = r; i < o.length; i++)
                        o[i].on("ready", function() {
                            if (t !== r.length && (t += 1),
                            t === r.length)
                                return n._readyConsent = r.reduce(function(e, t) {
            ...
            destroyPlayer: function(e) {
                ...
                t.splice(f(e, t))) : v("Cannot destroy an unknown player", "warn")
            },
            ...
            renderPlayer: function(e) {
                ...
                return ce(t).then(bt).catch(function(e) {
        ...
        integrations: new function() {
            ...
            this.getCookie = function(e, t) {
                ...
                if ("eloqua" === e && "function" == typeof window.GetElqCustomerGUID)
                    return window.GetElqCustomerGUID();
                for (var r = h(z[W.indexOf(e)], t), i = 0, o = n; i < o.length; i++) {
                    var a = o[i]
                      , u = a.indexOf("=")
            ...
            var r = function(e, t) {
              ...
              , o = function(e, t, n) {
                return (e = i(e, t)).foundIntegrations[t].sentPlayers.push(n),
                e
            }
              , a = function(e, t, n) {
                return (e = i(e, t)).foundIntegrations[t].externalIdentifier = n,
                e
            }
              , u = function(e, t, n) {
                if (!e.ready())
                ...
                return v("IntegrationsWatcher.communicateIntegration " + r, "debug"),
                B(r, "https://" + U(), e.iframe),
                !0
            }
              , c = function(t, n, r) {
              ...
              , y = function(e, t, n) {
                if ("marketo" === e) {
                    if (!n.integrations.marketo || -1 === t.toLowerCase().indexOf(n.integrations.marketo.toLowerCase()))
                        return null;
                    ...
                    data: {
                        body: {
                            trace: {
                                ...
                                frames: kt.parse(t).map(function(e) {
                                    return {
                                        code: e.source,
    ...
    s("error", "onerror", _t, window),
    s("unhandledrejection", "", function(e) {
        var t = e.reason
          , n = e.timeStamp
          , r = e.type;
        e.reason instanceof Error && Et(t.stack) && (e.preventDefault(),
        _t({
            error: t,
            filename: t.stack,
            message: t.message,
    ...
    var Ot = wt._debug
      , Ct = wt.api
      , It = wt.players;
    switch (window.VidyardV4 = window.VidyardV4 || wt,
    window.Vidyard = window.Vidyard || xt,
    document.readyState) {
    case "complete":
        Ct.renderDOMPlayers();
        break;
    ...
    !function(n, a) {
        ...
        void 0 === (o = "function" == typeof (r = function() {
            ...
            for (var s = 0; s < i.length; s++)
                ...
                u.prototype["set" + t(i[s])] = function(t) {
                    return function(n) {
                        if (!e(n))
            ...
            for (var l = 0; l < o.length; l++)
                u.prototype["get" + t(o[l])] = n(o[l]),
                u.prototype["set" + t(o[l])] = function(e) {
                    return function(t) {
                        this[e] = String(t)
                    }
                }(o[l]);
...
, function(e, t, n) {
    (function(e, t) {
        !function(e, n) {
            "use strict";
            if (!e.setImmediate) {
                var r, i, o, a, u, c = 1, s = {}, l = !1, d = e.document, f = Object.getPrototypeOf && Object.getPrototypeOf(e);
