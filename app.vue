  ...
  <div>
    ...
    <div id="__next">
      <main class="jsx-2839774277 __className_e3c363 __ptNoRemap font-sans">
              ...
              <a href="company/partners.html"
                ...
                <div class="flex gap-x-1">
                  <svg width="20" height="20" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M13.4999 7.89998H1.49994V7.09998H13.4999V7.89998Z" fill="currentColor" fill-rule="evenodd"
          ...
          <div
            ...
            <div class="px-4">
              <div class="rounded-sm bg-brand-gray px-3 py-6">
                <div class="mb-6 flex flex-row items-center justify-center text-sm font-semibold text-light-content">
                ...
                <div class="mb-4 flex flex-row justify-center gap-4">
                  <button
                    class="inline-flex h-[32px] w-[32px] items-center justify-center rounded-full text-dark-icon outline-none"
                    aria-label="Customise options" type="button" id="radix-:R1hkqdm:" aria-haspopup="menu"
                    aria-expanded="false" data-state="closed">
                    <div class="flex gap-x-1">
                      <svg width="20" height="20" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                    ...
                    class="group rounded border-2 border-brand-primary duration-200 px-3 py-2 font-semibold whitespace-nowrap bg-transparent rounded border-brand-primary active:bg-brand-red-1 active:border-brand-red-1 hover:border-brand-red-2 hover:bg-brand-red-2 hover:text-white text-brand-primary px-5 py-0.5 text-sm"
                    type="button">
                    <div class="flex items-center justify-center">
                      <div class="px-2">
                        <div class="flex flex-row items-center gap-1">
                          <i class="material-symbols-outlined text-brand-primary text-lg undefined"
                            translate="no">login</i>Log
                          In
                        </div>
                      </div>
                      <svg
              ...
              <div class="my-4 flex flex-col rounded-sm bg-brand-gray px-4 py-4">
        ...
        <main>
          <div>
            <div>
                    ...
                    <div
                      ...
                      <div class="w-full">
                        <h1
                          ...
                          It’s time to bring
                          <span
                            class="font-sans tracking-normal text-brand-primary leading-tight lg:leading-tight">clarity,
                            simplicity, and
                            security</span>
                  ...
                  <div class="animate-logoAnimation flex w-max" style="
                    ...
                    <div class="flex gap-4">
                      <div class="flex w-fit items-center justify-center">
                        <img alt="Barclays logo" loading="lazy" width="100" height="100" decoding="async" data-nimg="1"
                          class="max-h-10 min-h-[40px] w-full max-w-none object-contain" style="color: transparent"
                          srcset="
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Fbdee543a7500ad0542afd6cb8d91e356f4d96e53-200x40.svg&amp;w=128&amp;q=75 1x,
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Fbdee543a7500ad0542afd6cb8d91e356f4d96e53-200x40.svg&amp;w=256&amp;q=75 2x
                          "
                          src="_next/image6445.svg?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Fbdee543a7500ad0542afd6cb8d91e356f4d96e53-200x40.svg&amp;w=256&amp;q=75" />
                      </div>
                      <div class="flex w-fit items-center justify-center">
                        <img alt="Mastercard logo" loading="lazy" width="100" height="100" decoding="async"
                          data-nimg="1" class="max-h-10 min-h-[40px] w-full max-w-none object-contain"
                          style="color: transparent" srcset="
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Ff87aefabbf82b056dbe526602264dd0b8dbb90ff-200x40.svg&amp;w=128&amp;q=75 1x,
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Ff87aefabbf82b056dbe526602264dd0b8dbb90ff-200x40.svg&amp;w=256&amp;q=75 2x
                          "
                          src="_next/imageb721.svg?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Ff87aefabbf82b056dbe526602264dd0b8dbb90ff-200x40.svg&amp;w=256&amp;q=75" />
                      </div>
                      <div class="flex w-fit items-center justify-center">
                        <img alt="General Mills logo" loading="lazy" width="100" height="100" decoding="async"
                          data-nimg="1" class="max-h-10 min-h-[40px] w-full max-w-none object-contain"
                          style="color: transparent" srcset="
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Fb41b923caa4b9f61386e606fa20119150a87c0f3-150x46.svg&amp;w=128&amp;q=75 1x,
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Fb41b923caa4b9f61386e606fa20119150a87c0f3-150x46.svg&amp;w=256&amp;q=75 2x
                          "
                          src="_next/image6a51.svg?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Fb41b923caa4b9f61386e606fa20119150a87c0f3-150x46.svg&amp;w=256&amp;q=75" />
                      </div>
                      <div class="flex w-fit items-center justify-center">
                        <img alt="Heineken logo" loading="lazy" width="100" height="100" decoding="async" data-nimg="1"
                          class="max-h-10 min-h-[40px] w-full max-w-none object-contain" style="color: transparent"
                          srcset="
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F8d236518f504428a4c12758a44543f2aaac70dc5-200x40.svg&amp;w=128&amp;q=75 1x,
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F8d236518f504428a4c12758a44543f2aaac70dc5-200x40.svg&amp;w=256&amp;q=75 2x
                          "
                          src="_next/image5f5a.svg?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F8d236518f504428a4c12758a44543f2aaac70dc5-200x40.svg&amp;w=256&amp;q=75" />
                      </div>
                      <div class="flex w-fit items-center justify-center">
                        <img alt="Schneider Electric logo" loading="lazy" width="100" height="100" decoding="async"
                          data-nimg="1" class="max-h-10 min-h-[40px] w-full max-w-none object-contain"
                          style="color: transparent" srcset="
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F7143c838be550233024bbc22f070f1afc7edfa78-200x40.svg&amp;w=128&amp;q=75 1x,
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F7143c838be550233024bbc22f070f1afc7edfa78-200x40.svg&amp;w=256&amp;q=75 2x
                          "
                          src="_next/image5b2e.svg?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F7143c838be550233024bbc22f070f1afc7edfa78-200x40.svg&amp;w=256&amp;q=75" />
                      </div>
                      <div class="flex w-fit items-center justify-center">
                        <img alt="Parker logo" loading="lazy" width="100" height="100" decoding="async" data-nimg="1"
                          class="max-h-10 min-h-[40px] w-full max-w-none object-contain" style="color: transparent"
                          srcset="
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F6fb3afbecf934168a14dbc5a4c2ac7dede2f4253-200x40.svg&amp;w=128&amp;q=75 1x,
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F6fb3afbecf934168a14dbc5a4c2ac7dede2f4253-200x40.svg&amp;w=256&amp;q=75 2x
                          "
                          src="_next/imaged6cd.svg?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F6fb3afbecf934168a14dbc5a4c2ac7dede2f4253-200x40.svg&amp;w=256&amp;q=75" />
                      </div>
                      <div class="flex w-fit items-center justify-center">
                        <img alt="Televisa logo" loading="lazy" width="100" height="100" decoding="async" data-nimg="1"
                          class="max-h-10 min-h-[40px] w-full max-w-none object-contain" style="color: transparent"
                          srcset="
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Fc4d73a8abffa5e0b3d197fda319920aa381b4103-200x40.svg&amp;w=128&amp;q=75 1x,
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Fc4d73a8abffa5e0b3d197fda319920aa381b4103-200x40.svg&amp;w=256&amp;q=75 2x
                          "
                          src="_next/image47f5.svg?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Fc4d73a8abffa5e0b3d197fda319920aa381b4103-200x40.svg&amp;w=256&amp;q=75" />
                      </div>
                      <div class="flex w-fit items-center justify-center">
                        <img alt="Amaysim logo" loading="lazy" width="100" height="100" decoding="async" data-nimg="1"
                          class="max-h-10 min-h-[40px] w-full max-w-none object-contain" style="color: transparent"
                          srcset="
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F8c81afe2ff35f99fcbf287e75083926c51a7c060-200x40.svg&amp;w=128&amp;q=75 1x,
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F8c81afe2ff35f99fcbf287e75083926c51a7c060-200x40.svg&amp;w=256&amp;q=75 2x
                          "
                          src="_next/image4d51.svg?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F8c81afe2ff35f99fcbf287e75083926c51a7c060-200x40.svg&amp;w=256&amp;q=75" />
                      </div>
                      <div class="flex w-fit items-center justify-center">
                        <img alt="Aegon logo" loading="lazy" width="100" height="100" decoding="async" data-nimg="1"
                          class="max-h-10 min-h-[40px] w-full max-w-none object-contain" style="color: transparent"
                          srcset="
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Fd2e8fd11673e9aa397457ac08b803e52282a6e08-200x40.svg&amp;w=128&amp;q=75 1x,
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Fd2e8fd11673e9aa397457ac08b803e52282a6e08-200x40.svg&amp;w=256&amp;q=75 2x
                          "
                          src="_next/imageb1b9.svg?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Fd2e8fd11673e9aa397457ac08b803e52282a6e08-200x40.svg&amp;w=256&amp;q=75" />
                      </div>
                      <div class="flex w-fit items-center justify-center">
                        <img alt="Medtronic logo" loading="lazy" width="100" height="100" decoding="async" data-nimg="1"
                          class="max-h-10 min-h-[40px] w-full max-w-none object-contain" style="color: transparent"
                          srcset="
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Ff18aa89eb85f328df35c7ab91e06ff6d023bf2f8-200x40.svg&amp;w=128&amp;q=75 1x,
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Ff18aa89eb85f328df35c7ab91e06ff6d023bf2f8-200x40.svg&amp;w=256&amp;q=75 2x
                          "
                          src="_next/image81cc.svg?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Ff18aa89eb85f328df35c7ab91e06ff6d023bf2f8-200x40.svg&amp;w=256&amp;q=75" />
                      </div>
                      <div class="flex w-fit items-center justify-center">
                        <img alt="Innergex logo" loading="lazy" width="100" height="100" decoding="async" data-nimg="1"
                          class="max-h-10 min-h-[40px] w-full max-w-none object-contain" style="color: transparent"
                          srcset="
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F20289921cf3cd012f5bd4e08f92f5c556446322f-200x40.svg&amp;w=128&amp;q=75 1x,
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F20289921cf3cd012f5bd4e08f92f5c556446322f-200x40.svg&amp;w=256&amp;q=75 2x
                          "
                          src="_next/image0dc9.svg?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F20289921cf3cd012f5bd4e08f92f5c556446322f-200x40.svg&amp;w=256&amp;q=75" />
                      </div>
                      <div class="flex w-fit items-center justify-center">
                        <img alt="AsiaSat logo" loading="lazy" width="100" height="100" decoding="async" data-nimg="1"
                          class="max-h-10 min-h-[40px] w-full max-w-none object-contain" style="color: transparent"
                          srcset="
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F23f02ca21f0ea9c16d351738a8fb1767f3b7a245-200x40.svg&amp;w=128&amp;q=75 1x,
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F23f02ca21f0ea9c16d351738a8fb1767f3b7a245-200x40.svg&amp;w=256&amp;q=75 2x
                          "
                          src="_next/image82f7.svg?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F23f02ca21f0ea9c16d351738a8fb1767f3b7a245-200x40.svg&amp;w=256&amp;q=75" />
                      </div>
                      <div class="flex w-fit items-center justify-center">
                        <img alt="Crico logo" loading="lazy" width="100" height="100" decoding="async" data-nimg="1"
                          class="max-h-10 min-h-[40px] w-full max-w-none object-contain" style="color: transparent"
                          srcset="
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F8246dc548d226318972fce2c121f9f138e6f30de-200x40.svg&amp;w=128&amp;q=75 1x,
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F8246dc548d226318972fce2c121f9f138e6f30de-200x40.svg&amp;w=256&amp;q=75 2x
                          "
                          src="_next/image7b79.svg?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F8246dc548d226318972fce2c121f9f138e6f30de-200x40.svg&amp;w=256&amp;q=75" />
                      </div>
                      <div class="flex w-fit items-center justify-center">
                        <img alt="Nine logo" loading="lazy" width="100" height="100" decoding="async" data-nimg="1"
                          class="max-h-10 min-h-[40px] w-full max-w-none object-contain" style="color: transparent"
                          srcset="
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Fa78d5352d393f64bf0c2ff339e3cf8c8c62cdbcd-200x40.svg&amp;w=128&amp;q=75 1x,
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Fa78d5352d393f64bf0c2ff339e3cf8c8c62cdbcd-200x40.svg&amp;w=256&amp;q=75 2x
                          "
                          src="_next/image0967.svg?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Fa78d5352d393f64bf0c2ff339e3cf8c8c62cdbcd-200x40.svg&amp;w=256&amp;q=75" />
                      </div>
                      <div class="flex w-fit items-center justify-center">
                        <img alt="Casper logo" loading="lazy" width="100" height="100" decoding="async" data-nimg="1"
                          class="max-h-10 min-h-[40px] w-full max-w-none object-contain" style="color: transparent"
                          srcset="
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Ff18a7bdf4b0c7c287ce2fac4cb39ecfec8c4523a-200x40.svg&amp;w=128&amp;q=75 1x,
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Ff18a7bdf4b0c7c287ce2fac4cb39ecfec8c4523a-200x40.svg&amp;w=256&amp;q=75 2x
                          "
                          src="_next/image43b9.svg?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Ff18a7bdf4b0c7c287ce2fac4cb39ecfec8c4523a-200x40.svg&amp;w=256&amp;q=75" />
                      </div>
                      <div class="flex w-fit items-center justify-center">
                        <img alt="Oregon County logo" loading="lazy" width="100" height="100" decoding="async"
                          data-nimg="1" class="max-h-10 min-h-[40px] w-full max-w-none object-contain"
                          style="color: transparent" srcset="
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F0441d5dd3c163bad962e7c456d9cff54ec3d4ee3-150x46.svg&amp;w=128&amp;q=75 1x,
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F0441d5dd3c163bad962e7c456d9cff54ec3d4ee3-150x46.svg&amp;w=256&amp;q=75 2x
                          "
                          src="_next/image187b.svg?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F0441d5dd3c163bad962e7c456d9cff54ec3d4ee3-150x46.svg&amp;w=256&amp;q=75" />
                      </div>
                      <div class="flex w-fit items-center justify-center">
                        <img alt="Coca Cola logo" loading="lazy" width="100" height="100" decoding="async" data-nimg="1"
                          class="max-h-10 min-h-[40px] w-full max-w-none object-contain" style="color: transparent"
                          srcset="
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Fd0eb93bef7dbd988441a883837c445dfc4e1e24a-200x40.svg&amp;w=128&amp;q=75 1x,
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Fd0eb93bef7dbd988441a883837c445dfc4e1e24a-200x40.svg&amp;w=256&amp;q=75 2x
                          "
                          src="_next/imagead30.svg?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Fd0eb93bef7dbd988441a883837c445dfc4e1e24a-200x40.svg&amp;w=256&amp;q=75" />
                      </div>
                      <div class="flex w-fit items-center justify-center">
                        <img alt="TE Connectivity logo" loading="lazy" width="100" height="100" decoding="async"
                          data-nimg="1" class="max-h-10 min-h-[40px] w-full max-w-none object-contain"
                          style="color: transparent" srcset="
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F9dd2cac086c9c252e0f35da67ed4a4ee68cc7b2d-200x40.svg&amp;w=128&amp;q=75 1x,
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F9dd2cac086c9c252e0f35da67ed4a4ee68cc7b2d-200x40.svg&amp;w=256&amp;q=75 2x
                          "
                          src="_next/imagef4a9.svg?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F9dd2cac086c9c252e0f35da67ed4a4ee68cc7b2d-200x40.svg&amp;w=256&amp;q=75" />
                      </div>
                      <div class="flex w-fit items-center justify-center">
                        <img alt="Diebold Nixdorf logo" loading="lazy" width="100" height="100" decoding="async"
                          data-nimg="1" class="max-h-10 min-h-[40px] w-full max-w-none object-contain"
                          style="color: transparent" srcset="
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Fe8f46fca818fdf9e69dfceb55a9067665b19fd66-150x46.svg&amp;w=128&amp;q=75 1x,
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Fe8f46fca818fdf9e69dfceb55a9067665b19fd66-150x46.svg&amp;w=256&amp;q=75 2x
                          "
                          src="_next/image39e0.svg?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Fe8f46fca818fdf9e69dfceb55a9067665b19fd66-150x46.svg&amp;w=256&amp;q=75" />
                      </div>
                      <div class="flex w-fit items-center justify-center">
                        <img alt="Big Society Capital logo" loading="lazy" width="100" height="100" decoding="async"
                          data-nimg="1" class="max-h-10 min-h-[40px] w-full max-w-none object-contain"
                          style="color: transparent" srcset="
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Ff6351c1de0ef4f1a1d5458f3d2354990d0141be6-150x46.svg&amp;w=128&amp;q=75 1x,
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Ff6351c1de0ef4f1a1d5458f3d2354990d0141be6-150x46.svg&amp;w=256&amp;q=75 2x
                          "
                          src="_next/imagea03d.svg?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Ff6351c1de0ef4f1a1d5458f3d2354990d0141be6-150x46.svg&amp;w=256&amp;q=75" />
                      </div>
                      <div class="flex w-fit items-center justify-center">
                        <img alt="Wex logo" loading="lazy" width="100" height="100" decoding="async" data-nimg="1"
                          class="max-h-10 min-h-[40px] w-full max-w-none object-contain" style="color: transparent"
                          srcset="
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F68ff3e41852a71beefca2260357172b54b659959-200x40.svg&amp;w=128&amp;q=75 1x,
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F68ff3e41852a71beefca2260357172b54b659959-200x40.svg&amp;w=256&amp;q=75 2x
                          "
                          src="_next/image93bb.svg?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F68ff3e41852a71beefca2260357172b54b659959-200x40.svg&amp;w=256&amp;q=75" />
                      </div>
                      <div class="flex w-fit items-center justify-center">
                        <img alt="Bird &amp; Bird logo" loading="lazy" width="100" height="100" decoding="async"
                          data-nimg="1" class="max-h-10 min-h-[40px] w-full max-w-none object-contain"
                          style="color: transparent" srcset="
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F4d763bbcc97e26c38665aff3abf267532ee3040f-200x40.svg&amp;w=128&amp;q=75 1x,
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F4d763bbcc97e26c38665aff3abf267532ee3040f-200x40.svg&amp;w=256&amp;q=75 2x
                          "
                          src="_next/image4e6a.svg?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F4d763bbcc97e26c38665aff3abf267532ee3040f-200x40.svg&amp;w=256&amp;q=75" />
                      </div>
                      <div class="flex w-fit items-center justify-center">
                        <img alt="JB Hi-Fi logo" loading="lazy" width="100" height="100" decoding="async" data-nimg="1"
                          class="max-h-10 min-h-[40px] w-full max-w-none object-contain" style="color: transparent"
                          srcset="
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F8fd1c9e9b1b1dde5a759a94503fdd82208fdb712-200x40.svg&amp;w=128&amp;q=75 1x,
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F8fd1c9e9b1b1dde5a759a94503fdd82208fdb712-200x40.svg&amp;w=256&amp;q=75 2x
                          "
                          src="_next/imageedd8.svg?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F8fd1c9e9b1b1dde5a759a94503fdd82208fdb712-200x40.svg&amp;w=256&amp;q=75" />
                      </div>
                      <div class="flex w-fit items-center justify-center">
                        <img alt="Bic logo" loading="lazy" width="100" height="100" decoding="async" data-nimg="1"
                          class="max-h-10 min-h-[40px] w-full max-w-none object-contain" style="color: transparent"
                          srcset="
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F66f8c3c5be9ab9df20ea2271b971ee4808a298c0-200x40.svg&amp;w=128&amp;q=75 1x,
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F66f8c3c5be9ab9df20ea2271b971ee4808a298c0-200x40.svg&amp;w=256&amp;q=75 2x
                          "
                          src="_next/image4594.svg?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F66f8c3c5be9ab9df20ea2271b971ee4808a298c0-200x40.svg&amp;w=256&amp;q=75" />
                      </div>
                      <div class="flex w-fit items-center justify-center">
                        <img alt="Eaton logo" loading="lazy" width="100" height="100" decoding="async" data-nimg="1"
                          class="max-h-10 min-h-[40px] w-full max-w-none object-contain" style="color: transparent"
                          srcset="
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Fc1c0cd0e5023931f81808d4c5f7c3cd9d14d0356-200x40.svg&amp;w=128&amp;q=75 1x,
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Fc1c0cd0e5023931f81808d4c5f7c3cd9d14d0356-200x40.svg&amp;w=256&amp;q=75 2x
                          "
                          src="_next/image40e1.svg?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Fc1c0cd0e5023931f81808d4c5f7c3cd9d14d0356-200x40.svg&amp;w=256&amp;q=75" />
                      </div>
                      <div class="flex w-fit items-center justify-center">
                        <img alt="Imperfect foods logo" loading="lazy" width="100" height="100" decoding="async"
                          data-nimg="1" class="max-h-10 min-h-[40px] w-full max-w-none object-contain"
                          style="color: transparent" srcset="
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F48924adfddb9d40b2091c0c4f3796fe29f87281e-200x40.svg&amp;w=128&amp;q=75 1x,
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F48924adfddb9d40b2091c0c4f3796fe29f87281e-200x40.svg&amp;w=256&amp;q=75 2x
                          "
                          src="_next/image3bd0.svg?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F48924adfddb9d40b2091c0c4f3796fe29f87281e-200x40.svg&amp;w=256&amp;q=75" />
                      </div>
                      <div class="flex w-fit items-center justify-center">
                        <img alt="Babcock logo" loading="lazy" width="100" height="100" decoding="async" data-nimg="1"
                          class="max-h-10 min-h-[40px] w-full max-w-none object-contain" style="color: transparent"
                          srcset="
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Fbd7f2be3dcaaaeb38d783324137591108f3cffcd-150x47.svg&amp;w=128&amp;q=75 1x,
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Fbd7f2be3dcaaaeb38d783324137591108f3cffcd-150x47.svg&amp;w=256&amp;q=75 2x
                          "
                          src="_next/image6522.svg?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Fbd7f2be3dcaaaeb38d783324137591108f3cffcd-150x47.svg&amp;w=256&amp;q=75" />
                      </div>
                      <div class="flex w-fit items-center justify-center">
                        <img alt="randstad logo" loading="lazy" width="100" height="100" decoding="async" data-nimg="1"
                          class="max-h-10 min-h-[40px] w-full max-w-none object-contain" style="color: transparent"
                          srcset="
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Fcb37b65670c266051af9048f30b45c0d029a1f77-200x40.svg&amp;w=128&amp;q=75 1x,
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Fcb37b65670c266051af9048f30b45c0d029a1f77-200x40.svg&amp;w=256&amp;q=75 2x
                          "
                          src="_next/imagef167.svg?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Fcb37b65670c266051af9048f30b45c0d029a1f77-200x40.svg&amp;w=256&amp;q=75" />
                      </div>
                      <div class="flex w-fit items-center justify-center">
                        <img alt="Kiwi Rail logo" loading="lazy" width="100" height="100" decoding="async" data-nimg="1"
                          class="max-h-10 min-h-[40px] w-full max-w-none object-contain" style="color: transparent"
                          srcset="
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F97c065ca91c038a41259b168e6d8432bd61d806b-200x40.svg&amp;w=128&amp;q=75 1x,
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F97c065ca91c038a41259b168e6d8432bd61d806b-200x40.svg&amp;w=256&amp;q=75 2x
                          "
                          src="_next/image6e7a.svg?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F97c065ca91c038a41259b168e6d8432bd61d806b-200x40.svg&amp;w=256&amp;q=75" />
                      </div>
                      <div class="flex w-fit items-center justify-center">
                        <img alt="Seven Eleven logo" loading="lazy" width="100" height="100" decoding="async"
                          data-nimg="1" class="max-h-10 min-h-[40px] w-full max-w-none object-contain"
                          style="color: transparent" srcset="
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F96cbe8ae47b48e164484b0d0b275d7182b1063ba-150x46.svg&amp;w=128&amp;q=75 1x,
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F96cbe8ae47b48e164484b0d0b275d7182b1063ba-150x46.svg&amp;w=256&amp;q=75 2x
                          "
                          src="_next/imagef694.svg?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F96cbe8ae47b48e164484b0d0b275d7182b1063ba-150x46.svg&amp;w=256&amp;q=75" />
                      </div>
                      <div class="flex w-fit items-center justify-center">
                        <img alt="Dominos logo" loading="lazy" width="100" height="100" decoding="async" data-nimg="1"
                          class="max-h-10 min-h-[40px] w-full max-w-none object-contain" style="color: transparent"
                          srcset="
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F91fb1d64c9faf5c7349d9eab21005480e1a9383a-150x46.svg&amp;w=128&amp;q=75 1x,
                            /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F91fb1d64c9faf5c7349d9eab21005480e1a9383a-150x46.svg&amp;w=256&amp;q=75 2x
                          "
                          src="_next/image35ae.svg?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F91fb1d64c9faf5c7349d9eab21005480e1a9383a-150x46.svg&amp;w=256&amp;q=75" />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="container mx-auto flex px-4 lg:flex-row flex-col my-8 lg:my-4 lg:gap-16">
                  <div class="relative p-4 lg:basis-1/2">
                    <img alt="Image of Forrester recognizes Diligent as a Leader in GRC software" loading="lazy"
                      ...
                      style="color: transparent; object-fit: contain" srcset="
                        /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Fe7fdd088c7c28da2dbc7521c7f8751665d80e4cb-2340x2300.png%3Fq%3D90%26fit%3Dmax%26auto%3Dformat&amp;w=640&amp;q=75  1x,
                        /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Fe7fdd088c7c28da2dbc7521c7f8751665d80e4cb-2340x2300.png%3Fq%3D90%26fit%3Dmax%26auto%3Dformat&amp;w=1080&amp;q=75 2x
                      "
              ...
              <!-- <section id class="py-8 lg:py-20 relative overflow-hidden bg-cover bg-center bg-no-repeat">
                <div class="container px-4">
                  <div
                    class="absolute left-0 top-0 h-full w-full origin-top-left overflow-hidden bg-brand-dim lg:-top-20 lg:-skew-y-6">
                  </div>
                  <h2
                    class="font-sans tracking-normal text-3xl lg:text-4xl text-white font-bold leading-tight lg:leading-tight relative z-10 pb-5 text-center lg:pb-20">
                    <span>Transform
                    </span><span>today’s
                    </span><span>risks
                    </span><span>into
                    ...
                    <div class="relative flex flex-col items-center">
                      <div class="container max-w-lg overflow-y-visible pb-4 lg:pb-10">
                        <svg xmlns="http://www.w3.org/2000/svg" xml:space="preserve" id="Layer_1" x="0" y="0"
                          version="1.1" viewBox="0 0 2158.75 2334">
                          <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0" y="0"
                            xml:space="preserve" viewBox="0 0 2158.75 2334">
                            <g id="circle__data-feeds">
                              <circle cx="973.621" cy="1176.739" r="925.861"
                                class="fill-[#d8d8d8] stroke-[#ff0000] stroke-[8px]" style="stroke-miterlimit: 10">
                              </circle>
                              <path
                                ...
                                class="fill-[#282e37]"></path>
                            </g>
                          </svg><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0" y="0"
                            xml:space="preserve" viewBox="0 0 2158.75 2334">
                            <g id="circle__analytics">
                              <ellipse cx="981.937" cy="1198.143" class="fill-[#f1f1f1]" rx="816.312" ry="808.5">
                              </ellipse>
                              <path
                            ...
                            xml:space="preserve" viewBox="0 0 2158.75 2334">
                            <g id="circle__continuous-monitoring">
                              <circle cx="989.39" cy="1198.143" r="697.926" class="fill-[#ffffff]"></circle>
                              <path
                            ...
                            xml:space="preserve" viewBox="0 0 2158.75 2334">
                            <g id="circle__red-center">
                              <circle cx="981.937" cy="1198.143" r="585.926" class="fill-[#ee312e]"></circle>
                              <path
                            ...
                            xml:space="preserve" viewBox="0 0 2158.75 2334">
                            <g id="circle__board-reporting">
                              <path
                                d="M958.79 52.388c627.437 0 1136.075 500.993 1136.075 1119s-508.638 1119-1136.075 1119"
                                class="fill-[#f3f3f3] stroke-[#f3f3f3] stroke-[8px]" style="stroke-miterlimit: 10">
                              </path>
                              <path
                          ...
                          <g>
                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0" y="0"
                              xml:space="preserve" viewBox="0 0 2158.75 2334">
                              <g id="slice__risk" class="relative z-40 origin-center transition-all false">
                                <path
                                ...
                                <path
                                  d="m961.79 151.476.001 1024.937 600.851-829.331c-168.683-123.03-376.314-195.606-600.852-195.606z"
                                  class="fill-none stroke-[#00d0f0] stroke-[8px]" style="
                          ...
                          <g>
                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0" y="0"
                              xml:space="preserve" viewBox="0 0 2158.75 2334">
                              <g id="slice__audit" class="relative z-40 origin-center transition-all false">
                                <path
                          ...
                          <g>
                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0" y="0"
                              xml:space="preserve" viewBox="0 0 2158.75 2334">
                              <g id="slice__governance" class="relative z-40 origin-center transition-all false">
                                <path
                                ...
                                <path
                                  d="M1934.453 859.484 961.79 1176.412l972.993 317.035c32.215-99.674 49.626-206.034 49.626-316.472 0-110.814-17.53-217.522-49.956-317.491z"
                                  class="fill-none stroke-[#0083f7] stroke-[8px]" style="
                                    stroke-linejoin: round;
                                    stroke-miterlimit: 10;
                                  "></path>
                                <path d="M1416.631 1141.756h585.244v68.517h-585.244z" class="fill-none"></path>
                          ...
                          <g>
                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0" y="0"
                              xml:space="preserve" viewBox="0 0 2158.75 2334">
                              <g id="slice__compliance" class="relative z-40 origin-center transition-all false">
                                <path
                          ...
                          <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0" y="0"
                            xml:space="preserve" viewBox="0 0 2158.75 2334">
                            <g id="circle__center-logo">
                              <circle cx="987.937" cy="1179.415" r="164" class="fill-white drop-shadow-lg"></circle>
                              <path
                ...
                <div class="container mx-auto flex px-4 lg:flex-row flex-col my-8 lg:my-4 lg:gap-16">
                  <div class="relative p-4 lg:basis-1/2">
                    <img alt="Image of Elevate strategic risk management " loading="lazy" width="500" height="350"
                      decoding="async" data-nimg="1" style="color: transparent; object-fit: contain" srcset="
                        /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F34b1a095e597e23ebc02b3fe1cfcf0fbca41906c-2340x1630.png%3Fq%3D90%26fit%3Dmax%26auto%3Dformat&amp;w=640&amp;q=75  1x,
                        /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F34b1a095e597e23ebc02b3fe1cfcf0fbca41906c-2340x1630.png%3Fq%3D90%26fit%3Dmax%26auto%3Dformat&amp;w=1080&amp;q=75 2x
                      "
                ...
                <div class="container mx-auto flex px-4 lg:flex-row-reverse flex-col my-8 lg:my-4 lg:gap-16">
                  <div class="relative p-4 lg:basis-1/2">
                    <img alt="Image of Enable growth" loading="lazy" width="500" height="350" decoding="async"
                      data-nimg="1" style="color: transparent; object-fit: contain" srcset="
                        /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F7d555120bc36cfc7da18ed84cd4e08cb3dec8c7f-2340x1630.png%3Fq%3D90%26fit%3Dmax%26auto%3Dformat&amp;w=640&amp;q=75  1x,
                        /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2F7d555120bc36cfc7da18ed84cd4e08cb3dec8c7f-2340x1630.png%3Fq%3D90%26fit%3Dmax%26auto%3Dformat&amp;w=1080&amp;q=75 2x
                      "
                ...
                <div class="container mx-auto flex px-4 lg:flex-row flex-col my-8 lg:my-4 lg:gap-16">
                  <div class="relative p-4 lg:basis-1/2">
                    <img alt="Image of Ensure regulatory compliance" loading="lazy" width="500" height="350"
                      decoding="async" data-nimg="1" style="color: transparent; object-fit: contain" srcset="
                        /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Ff5056e6e088e7b9d6ca654aeacb665db67c09d37-2340x1630.png%3Fq%3D90%26fit%3Dmax%26auto%3Dformat&amp;w=640&amp;q=75  1x,
                        /_next/image?url=https%3A%2F%2Fcdn.sanity.io%2Fimages%2F33u1mixi%2Fproduction%2Ff5056e6e088e7b9d6ca654aeacb665db67c09d37-2340x1630.png%3Fq%3D90%26fit%3Dmax%26auto%3Dformat&amp;w=1080&amp;q=75 2x
                      "
                    ...
                    <div class="-mt-8 w-full md:max-w-[455px] xl:-mb-8 xl:w-96 xl:max-w-[255px] xl:flex-none">
                      <div class="relative aspect-[2/1] h-full md:-mx-8 xl:mx-0 xl:aspect-auto">
                        <img alt="Barclays" loading="lazy" width="455" height="227" decoding="async" data-nimg="1"
                          ...
                          srcset="
                            https://cdn.sanity.io/images/33u1mixi/production/d15663fb773fdb7f3db14fb5ec3c57d9f2fa9c4e-4320x2700.webp?rect=644,0,2100,2700&amp;w=384&amp;q=90&amp;fit=clip&amp;auto=format   384w,
                            https://cdn.sanity.io/images/33u1mixi/production/d15663fb773fdb7f3db14fb5ec3c57d9f2fa9c4e-4320x2700.webp?rect=644,0,2100,2700&amp;w=640&amp;q=90&amp;fit=clip&amp;auto=format   640w,
                            https://cdn.sanity.io/images/33u1mixi/production/d15663fb773fdb7f3db14fb5ec3c57d9f2fa9c4e-4320x2700.webp?rect=644,0,2100,2700&amp;w=750&amp;q=90&amp;fit=clip&amp;auto=format   750w,
                            https://cdn.sanity.io/images/33u1mixi/production/d15663fb773fdb7f3db14fb5ec3c57d9f2fa9c4e-4320x2700.webp?rect=644,0,2100,2700&amp;w=828&amp;q=90&amp;fit=clip&amp;auto=format   828w,
                            https://cdn.sanity.io/images/33u1mixi/production/d15663fb773fdb7f3db14fb5ec3c57d9f2fa9c4e-4320x2700.webp?rect=644,0,2100,2700&amp;w=1080&amp;q=90&amp;fit=clip&amp;auto=format 1080w,
                            https://cdn.sanity.io/images/33u1mixi/production/d15663fb773fdb7f3db14fb5ec3c57d9f2fa9c4e-4320x2700.webp?rect=644,0,2100,2700&amp;w=1200&amp;q=90&amp;fit=clip&amp;auto=format 1200w,
                            https://cdn.sanity.io/images/33u1mixi/production/d15663fb773fdb7f3db14fb5ec3c57d9f2fa9c4e-4320x2700.webp?rect=644,0,2100,2700&amp;w=1920&amp;q=90&amp;fit=clip&amp;auto=format 1920w,
                            https://cdn.sanity.io/images/33u1mixi/production/d15663fb773fdb7f3db14fb5ec3c57d9f2fa9c4e-4320x2700.webp?rect=644,0,2100,2700&amp;w=2048&amp;q=90&amp;fit=clip&amp;auto=format 2048w,
                            https://cdn.sanity.io/images/33u1mixi/production/d15663fb773fdb7f3db14fb5ec3c57d9f2fa9c4e-4320x2700.webp?rect=644,0,2100,2700&amp;w=3840&amp;q=90&amp;fit=clip&amp;auto=format 3840w
                          "
              ...
              <!-- <section id class="relative py-16 lg:py-32">
                <div class="container px-4">
                  <div class="pb-7 text-center">
                    <h2
                      class="font-sans tracking-normal text-3xl lg:text-4xl text-gray-900 leading-tight lg:leading-tight">
                      Related content
                    </h2>
                  </div>
                  <div class="container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 py-0">
                    <a class="relative flex h-[388px] max-h-[388px] min-h-[72px] min-w-[100px] flex-col justify-between overflow-hidden rounded-lg bg-brand-white shadow-card"
                          ...
                          <div
                            ...
                            <figure
                              ...
                              <div class="h-0 w-full max-w-full pb-[75%]">
                                <div class="absolute left-0 top-0 h-full w-full origin-center will-change-transform">
                                  <picture class="flex h-[300px] w-full max-w-none"><img
                                      ...
                                      class="object-center object-cover" style="
                                        ...
                                        bottom: 0;
                                        color: transparent;
                                      " sizes="240w 100vw" srcset="
                                        https://cdn.sanity.io/images/33u1mixi/production/7ef13321754c150f46ae8370675e14d1efce6c2e-1080x720.jpg?w=640&amp;q=90&amp;fit=clip&amp;auto=format   640w,
                                        https://cdn.sanity.io/images/33u1mixi/production/7ef13321754c150f46ae8370675e14d1efce6c2e-1080x720.jpg?w=750&amp;q=90&amp;fit=clip&amp;auto=format   750w,
                                        https://cdn.sanity.io/images/33u1mixi/production/7ef13321754c150f46ae8370675e14d1efce6c2e-1080x720.jpg?w=828&amp;q=90&amp;fit=clip&amp;auto=format   828w,
                                        https://cdn.sanity.io/images/33u1mixi/production/7ef13321754c150f46ae8370675e14d1efce6c2e-1080x720.jpg?w=1080&amp;q=90&amp;fit=clip&amp;auto=format 1080w,
                                        https://cdn.sanity.io/images/33u1mixi/production/7ef13321754c150f46ae8370675e14d1efce6c2e-1080x720.jpg?w=1200&amp;q=90&amp;fit=clip&amp;auto=format 1200w,
                                        https://cdn.sanity.io/images/33u1mixi/production/7ef13321754c150f46ae8370675e14d1efce6c2e-1080x720.jpg?w=1920&amp;q=90&amp;fit=clip&amp;auto=format 1920w,
                                        https://cdn.sanity.io/images/33u1mixi/production/7ef13321754c150f46ae8370675e14d1efce6c2e-1080x720.jpg?w=2048&amp;q=90&amp;fit=clip&amp;auto=format 2048w,
                                        https://cdn.sanity.io/images/33u1mixi/production/7ef13321754c150f46ae8370675e14d1efce6c2e-1080x720.jpg?w=3840&amp;q=90&amp;fit=clip&amp;auto=format 3840w
                                      "
                      ...
                      <button
                        class="inline-flex items-center justify-center rounded-md font-semibold transition-colors duration-300 focus:outline-none text-brand-primary hover:text-brand-primary-dark focus:ring-brand-primary-dark px-4 py-3 text-base self-start">
                        Read more<svg
                          class="relative top-[1px] flex h-3 w-3 fill-none stroke-current stroke-[1.5] transition-transform duration-150 ml-[6px] undefined"
                          fill="none" stroke="currentColor" viewBox="0 0 10 10" aria-hidden="true">
                          <g fill-rule="evenodd">
                                ...
                                <div class="absolute left-0 top-0 h-full w-full origin-center will-change-transform">
                                  <picture class="flex h-[300px] w-full max-w-none"><img
                                      ...
                                      class="object-center object-cover" style="
                                        ...
                                        color: transparent;
                                      " sizes="240w 100vw" srcset="
                                        https://cdn.sanity.io/images/33u1mixi/production/91928133ffeaf4a72748532d135837eff8dcff69-3334x2501.png?w=640&amp;q=90&amp;fit=clip&amp;auto=format   640w,
                                        https://cdn.sanity.io/images/33u1mixi/production/91928133ffeaf4a72748532d135837eff8dcff69-3334x2501.png?w=750&amp;q=90&amp;fit=clip&amp;auto=format   750w,
                                        https://cdn.sanity.io/images/33u1mixi/production/91928133ffeaf4a72748532d135837eff8dcff69-3334x2501.png?w=828&amp;q=90&amp;fit=clip&amp;auto=format   828w,
                                        https://cdn.sanity.io/images/33u1mixi/production/91928133ffeaf4a72748532d135837eff8dcff69-3334x2501.png?w=1080&amp;q=90&amp;fit=clip&amp;auto=format 1080w,
                                        https://cdn.sanity.io/images/33u1mixi/production/91928133ffeaf4a72748532d135837eff8dcff69-3334x2501.png?w=1200&amp;q=90&amp;fit=clip&amp;auto=format 1200w,
                                        https://cdn.sanity.io/images/33u1mixi/production/91928133ffeaf4a72748532d135837eff8dcff69-3334x2501.png?w=1920&amp;q=90&amp;fit=clip&amp;auto=format 1920w,
                                        https://cdn.sanity.io/images/33u1mixi/production/91928133ffeaf4a72748532d135837eff8dcff69-3334x2501.png?w=2048&amp;q=90&amp;fit=clip&amp;auto=format 2048w,
                                        https://cdn.sanity.io/images/33u1mixi/production/91928133ffeaf4a72748532d135837eff8dcff69-3334x2501.png?w=3840&amp;q=90&amp;fit=clip&amp;auto=format 3840w
                                      "
                          ...
                          <div
                            ...
                            <figure
                              ...
                              <div class="h-0 w-full max-w-full pb-[75%]">
                                <div class="absolute left-0 top-0 h-full w-full origin-center will-change-transform">
                                  <picture class="flex h-[300px] w-full max-w-none"><img
                                      alt="Your guide to GRC vendor consolidation" loading="lazy" decoding="async"
                                      data-nimg="fill" class="object-center object-cover" style="
                                        position: absolute;
                                        height: 100%;
                                        width: 100%;
                                        left: 0;
                                        ...
                                        color: transparent;
                                      " sizes="240w 100vw" srcset="
                                        https://cdn.sanity.io/images/33u1mixi/production/390236a7f54c1b802a03ad94f9dd09c4a9963a2d-3334x2501.jpg?w=640&amp;q=90&amp;fit=clip&amp;auto=format   640w,
                                        https://cdn.sanity.io/images/33u1mixi/production/390236a7f54c1b802a03ad94f9dd09c4a9963a2d-3334x2501.jpg?w=750&amp;q=90&amp;fit=clip&amp;auto=format   750w,
                                        https://cdn.sanity.io/images/33u1mixi/production/390236a7f54c1b802a03ad94f9dd09c4a9963a2d-3334x2501.jpg?w=828&amp;q=90&amp;fit=clip&amp;auto=format   828w,
                                        https://cdn.sanity.io/images/33u1mixi/production/390236a7f54c1b802a03ad94f9dd09c4a9963a2d-3334x2501.jpg?w=1080&amp;q=90&amp;fit=clip&amp;auto=format 1080w,
                                        https://cdn.sanity.io/images/33u1mixi/production/390236a7f54c1b802a03ad94f9dd09c4a9963a2d-3334x2501.jpg?w=1200&amp;q=90&amp;fit=clip&amp;auto=format 1200w,
                                        https://cdn.sanity.io/images/33u1mixi/production/390236a7f54c1b802a03ad94f9dd09c4a9963a2d-3334x2501.jpg?w=1920&amp;q=90&amp;fit=clip&amp;auto=format 1920w,
                                        https://cdn.sanity.io/images/33u1mixi/production/390236a7f54c1b802a03ad94f9dd09c4a9963a2d-3334x2501.jpg?w=2048&amp;q=90&amp;fit=clip&amp;auto=format 2048w,
                                        https://cdn.sanity.io/images/33u1mixi/production/390236a7f54c1b802a03ad94f9dd09c4a9963a2d-3334x2501.jpg?w=3840&amp;q=90&amp;fit=clip&amp;auto=format 3840w
                                      "
                                ...
                                <div class="absolute left-0 top-0 h-full w-full origin-center will-change-transform">
                                  <picture class="flex h-[300px] w-full max-w-none"><img
                                      ...
                                      class="object-center object-cover" style="
                                        ...
                                        color: transparent;
                                      " sizes="240w 100vw" srcset="
                                        https://cdn.sanity.io/images/33u1mixi/production/99c7224c9e1d6d90ef746a0bd0a35f5c56fa7d31-1080x720.jpg?w=640&amp;q=90&amp;fit=clip&amp;auto=format   640w,
                                        https://cdn.sanity.io/images/33u1mixi/production/99c7224c9e1d6d90ef746a0bd0a35f5c56fa7d31-1080x720.jpg?w=750&amp;q=90&amp;fit=clip&amp;auto=format   750w,
                                        https://cdn.sanity.io/images/33u1mixi/production/99c7224c9e1d6d90ef746a0bd0a35f5c56fa7d31-1080x720.jpg?w=828&amp;q=90&amp;fit=clip&amp;auto=format   828w,
                                        https://cdn.sanity.io/images/33u1mixi/production/99c7224c9e1d6d90ef746a0bd0a35f5c56fa7d31-1080x720.jpg?w=1080&amp;q=90&amp;fit=clip&amp;auto=format 1080w,
                                        https://cdn.sanity.io/images/33u1mixi/production/99c7224c9e1d6d90ef746a0bd0a35f5c56fa7d31-1080x720.jpg?w=1200&amp;q=90&amp;fit=clip&amp;auto=format 1200w,
                                        https://cdn.sanity.io/images/33u1mixi/production/99c7224c9e1d6d90ef746a0bd0a35f5c56fa7d31-1080x720.jpg?w=1920&amp;q=90&amp;fit=clip&amp;auto=format 1920w,
                                        https://cdn.sanity.io/images/33u1mixi/production/99c7224c9e1d6d90ef746a0bd0a35f5c56fa7d31-1080x720.jpg?w=2048&amp;q=90&amp;fit=clip&amp;auto=format 2048w,
                                        https://cdn.sanity.io/images/33u1mixi/production/99c7224c9e1d6d90ef746a0bd0a35f5c56fa7d31-1080x720.jpg?w=3840&amp;q=90&amp;fit=clip&amp;auto=format 3840w
                                      "
                  ...
                  <div class="mb-4 flex flex-wrap items-center justify-evenly gap-4 pb-8 pt-5 md:flex-row">
                    <div>
                      <img alt="Image 0" loading="lazy" width="200" height="200" decoding="async" data-nimg="1"
                        ...
                        sizes="(max-width: 600px) 90vw, (max-width: 1200px) 60vw, 500px" srcset="
                          https://cdn.sanity.io/images/33u1mixi/production/b2b4fb47d8a545eafab82cd39185b1da68cbee42-200x117.png?w=384&amp;q=90&amp;fit=clip&amp;auto=format   384w,
                          https://cdn.sanity.io/images/33u1mixi/production/b2b4fb47d8a545eafab82cd39185b1da68cbee42-200x117.png?w=640&amp;q=90&amp;fit=clip&amp;auto=format   640w,
                          https://cdn.sanity.io/images/33u1mixi/production/b2b4fb47d8a545eafab82cd39185b1da68cbee42-200x117.png?w=750&amp;q=90&amp;fit=clip&amp;auto=format   750w,
                          https://cdn.sanity.io/images/33u1mixi/production/b2b4fb47d8a545eafab82cd39185b1da68cbee42-200x117.png?w=828&amp;q=90&amp;fit=clip&amp;auto=format   828w,
                          https://cdn.sanity.io/images/33u1mixi/production/b2b4fb47d8a545eafab82cd39185b1da68cbee42-200x117.png?w=1080&amp;q=90&amp;fit=clip&amp;auto=format 1080w,
                          https://cdn.sanity.io/images/33u1mixi/production/b2b4fb47d8a545eafab82cd39185b1da68cbee42-200x117.png?w=1200&amp;q=90&amp;fit=clip&amp;auto=format 1200w,
                          https://cdn.sanity.io/images/33u1mixi/production/b2b4fb47d8a545eafab82cd39185b1da68cbee42-200x117.png?w=1920&amp;q=90&amp;fit=clip&amp;auto=format 1920w,
                          https://cdn.sanity.io/images/33u1mixi/production/b2b4fb47d8a545eafab82cd39185b1da68cbee42-200x117.png?w=2048&amp;q=90&amp;fit=clip&amp;auto=format 2048w,
                          https://cdn.sanity.io/images/33u1mixi/production/b2b4fb47d8a545eafab82cd39185b1da68cbee42-200x117.png?w=3840&amp;q=90&amp;fit=clip&amp;auto=format 3840w
                        "
                    ...
                    <div>
                      <img alt="Image 1" loading="lazy" width="200" height="200" decoding="async" data-nimg="1"
                        class="false undefined max-h-[80px] max-w-[120px]" style="color: transparent"
                        sizes="(max-width: 600px) 90vw, (max-width: 1200px) 60vw, 500px" srcset="
                          https://cdn.sanity.io/images/33u1mixi/production/37d6a5d06855594bf62e03d15dcce304c6797889-800x439.png?w=384&amp;q=90&amp;fit=clip&amp;auto=format   384w,
                          https://cdn.sanity.io/images/33u1mixi/production/37d6a5d06855594bf62e03d15dcce304c6797889-800x439.png?w=640&amp;q=90&amp;fit=clip&amp;auto=format   640w,
                          https://cdn.sanity.io/images/33u1mixi/production/37d6a5d06855594bf62e03d15dcce304c6797889-800x439.png?w=750&amp;q=90&amp;fit=clip&amp;auto=format   750w,
                          https://cdn.sanity.io/images/33u1mixi/production/37d6a5d06855594bf62e03d15dcce304c6797889-800x439.png?w=828&amp;q=90&amp;fit=clip&amp;auto=format   828w,
                          https://cdn.sanity.io/images/33u1mixi/production/37d6a5d06855594bf62e03d15dcce304c6797889-800x439.png?w=1080&amp;q=90&amp;fit=clip&amp;auto=format 1080w,
                          https://cdn.sanity.io/images/33u1mixi/production/37d6a5d06855594bf62e03d15dcce304c6797889-800x439.png?w=1200&amp;q=90&amp;fit=clip&amp;auto=format 1200w,
                          https://cdn.sanity.io/images/33u1mixi/production/37d6a5d06855594bf62e03d15dcce304c6797889-800x439.png?w=1920&amp;q=90&amp;fit=clip&amp;auto=format 1920w,
                          https://cdn.sanity.io/images/33u1mixi/production/37d6a5d06855594bf62e03d15dcce304c6797889-800x439.png?w=2048&amp;q=90&amp;fit=clip&amp;auto=format 2048w,
                          https://cdn.sanity.io/images/33u1mixi/production/37d6a5d06855594bf62e03d15dcce304c6797889-800x439.png?w=3840&amp;q=90&amp;fit=clip&amp;auto=format 3840w
                        "
                    ...
                    <div>
                      <img alt="Image 2" loading="lazy" width="200" height="200" decoding="async" data-nimg="1"
                        class="false undefined max-h-[80px] max-w-[120px]" style="color: transparent"
                        sizes="(max-width: 600px) 90vw, (max-width: 1200px) 60vw, 500px" srcset="
                          https://cdn.sanity.io/images/33u1mixi/production/dc27e7d33ff7f7e30303cc5ad9da07a222ddf45b-177x63.png?w=384&amp;q=90&amp;fit=clip&amp;auto=format   384w,
                          https://cdn.sanity.io/images/33u1mixi/production/dc27e7d33ff7f7e30303cc5ad9da07a222ddf45b-177x63.png?w=640&amp;q=90&amp;fit=clip&amp;auto=format   640w,
                          https://cdn.sanity.io/images/33u1mixi/production/dc27e7d33ff7f7e30303cc5ad9da07a222ddf45b-177x63.png?w=750&amp;q=90&amp;fit=clip&amp;auto=format   750w,
                          https://cdn.sanity.io/images/33u1mixi/production/dc27e7d33ff7f7e30303cc5ad9da07a222ddf45b-177x63.png?w=828&amp;q=90&amp;fit=clip&amp;auto=format   828w,
                          https://cdn.sanity.io/images/33u1mixi/production/dc27e7d33ff7f7e30303cc5ad9da07a222ddf45b-177x63.png?w=1080&amp;q=90&amp;fit=clip&amp;auto=format 1080w,
                          https://cdn.sanity.io/images/33u1mixi/production/dc27e7d33ff7f7e30303cc5ad9da07a222ddf45b-177x63.png?w=1200&amp;q=90&amp;fit=clip&amp;auto=format 1200w,
                          https://cdn.sanity.io/images/33u1mixi/production/dc27e7d33ff7f7e30303cc5ad9da07a222ddf45b-177x63.png?w=1920&amp;q=90&amp;fit=clip&amp;auto=format 1920w,
                          https://cdn.sanity.io/images/33u1mixi/production/dc27e7d33ff7f7e30303cc5ad9da07a222ddf45b-177x63.png?w=2048&amp;q=90&amp;fit=clip&amp;auto=format 2048w,
                          https://cdn.sanity.io/images/33u1mixi/production/dc27e7d33ff7f7e30303cc5ad9da07a222ddf45b-177x63.png?w=3840&amp;q=90&amp;fit=clip&amp;auto=format 3840w
                        "
                    ...
                    <div>
                      <img alt="Image 3" loading="lazy" width="200" height="200" decoding="async" data-nimg="1"
                        class="false undefined max-h-[80px] max-w-[120px]" style="color: transparent"
                        sizes="(max-width: 600px) 90vw, (max-width: 1200px) 60vw, 500px" srcset="
                          https://cdn.sanity.io/images/33u1mixi/production/6110044bd0da11139fee025ac486681c85cbd022-82x80.svg?w=384&amp;q=90&amp;fit=clip&amp;auto=format   384w,
                          https://cdn.sanity.io/images/33u1mixi/production/6110044bd0da11139fee025ac486681c85cbd022-82x80.svg?w=640&amp;q=90&amp;fit=clip&amp;auto=format   640w,
                          https://cdn.sanity.io/images/33u1mixi/production/6110044bd0da11139fee025ac486681c85cbd022-82x80.svg?w=750&amp;q=90&amp;fit=clip&amp;auto=format   750w,
                          https://cdn.sanity.io/images/33u1mixi/production/6110044bd0da11139fee025ac486681c85cbd022-82x80.svg?w=828&amp;q=90&amp;fit=clip&amp;auto=format   828w,
                          https://cdn.sanity.io/images/33u1mixi/production/6110044bd0da11139fee025ac486681c85cbd022-82x80.svg?w=1080&amp;q=90&amp;fit=clip&amp;auto=format 1080w,
                          https://cdn.sanity.io/images/33u1mixi/production/6110044bd0da11139fee025ac486681c85cbd022-82x80.svg?w=1200&amp;q=90&amp;fit=clip&amp;auto=format 1200w,
                          https://cdn.sanity.io/images/33u1mixi/production/6110044bd0da11139fee025ac486681c85cbd022-82x80.svg?w=1920&amp;q=90&amp;fit=clip&amp;auto=format 1920w,
                          https://cdn.sanity.io/images/33u1mixi/production/6110044bd0da11139fee025ac486681c85cbd022-82x80.svg?w=2048&amp;q=90&amp;fit=clip&amp;auto=format 2048w,
                          https://cdn.sanity.io/images/33u1mixi/production/6110044bd0da11139fee025ac486681c85cbd022-82x80.svg?w=3840&amp;q=90&amp;fit=clip&amp;auto=format 3840w
                        "
                    ...
                    <div>
                      <img alt="Image 4" loading="lazy" width="200" height="200" decoding="async" data-nimg="1"
                        class="false undefined max-h-[80px] max-w-[120px]" style="color: transparent"
                        sizes="(max-width: 600px) 90vw, (max-width: 1200px) 60vw, 500px" srcset="
                          https://cdn.sanity.io/images/33u1mixi/production/25db433de34821c0f3bdc6ffa020e2960209176d-543x313.png?w=384&amp;q=90&amp;fit=clip&amp;auto=format   384w,
                          https://cdn.sanity.io/images/33u1mixi/production/25db433de34821c0f3bdc6ffa020e2960209176d-543x313.png?w=640&amp;q=90&amp;fit=clip&amp;auto=format   640w,
                          https://cdn.sanity.io/images/33u1mixi/production/25db433de34821c0f3bdc6ffa020e2960209176d-543x313.png?w=750&amp;q=90&amp;fit=clip&amp;auto=format   750w,
                          https://cdn.sanity.io/images/33u1mixi/production/25db433de34821c0f3bdc6ffa020e2960209176d-543x313.png?w=828&amp;q=90&amp;fit=clip&amp;auto=format   828w,
                          https://cdn.sanity.io/images/33u1mixi/production/25db433de34821c0f3bdc6ffa020e2960209176d-543x313.png?w=1080&amp;q=90&amp;fit=clip&amp;auto=format 1080w,
                          https://cdn.sanity.io/images/33u1mixi/production/25db433de34821c0f3bdc6ffa020e2960209176d-543x313.png?w=1200&amp;q=90&amp;fit=clip&amp;auto=format 1200w,
                          https://cdn.sanity.io/images/33u1mixi/production/25db433de34821c0f3bdc6ffa020e2960209176d-543x313.png?w=1920&amp;q=90&amp;fit=clip&amp;auto=format 1920w,
                          https://cdn.sanity.io/images/33u1mixi/production/25db433de34821c0f3bdc6ffa020e2960209176d-543x313.png?w=2048&amp;q=90&amp;fit=clip&amp;auto=format 2048w,
                          https://cdn.sanity.io/images/33u1mixi/production/25db433de34821c0f3bdc6ffa020e2960209176d-543x313.png?w=3840&amp;q=90&amp;fit=clip&amp;auto=format 3840w
                        "
                    ...
                    <div>
                      <img alt="Image 5" loading="lazy" width="200" height="200" decoding="async" data-nimg="1"
                        class="false undefined max-h-[80px] max-w-[120px]" style="color: transparent"
                        sizes="(max-width: 600px) 90vw, (max-width: 1200px) 60vw, 500px" srcset="
                          https://cdn.sanity.io/images/33u1mixi/production/39760c243eb79af4cffe8658b5a6870a111879ca-72x91.svg?w=384&amp;q=90&amp;fit=clip&amp;auto=format   384w,
                          https://cdn.sanity.io/images/33u1mixi/production/39760c243eb79af4cffe8658b5a6870a111879ca-72x91.svg?w=640&amp;q=90&amp;fit=clip&amp;auto=format   640w,
                          https://cdn.sanity.io/images/33u1mixi/production/39760c243eb79af4cffe8658b5a6870a111879ca-72x91.svg?w=750&amp;q=90&amp;fit=clip&amp;auto=format   750w,
                          https://cdn.sanity.io/images/33u1mixi/production/39760c243eb79af4cffe8658b5a6870a111879ca-72x91.svg?w=828&amp;q=90&amp;fit=clip&amp;auto=format   828w,
                          https://cdn.sanity.io/images/33u1mixi/production/39760c243eb79af4cffe8658b5a6870a111879ca-72x91.svg?w=1080&amp;q=90&amp;fit=clip&amp;auto=format 1080w,
                          https://cdn.sanity.io/images/33u1mixi/production/39760c243eb79af4cffe8658b5a6870a111879ca-72x91.svg?w=1200&amp;q=90&amp;fit=clip&amp;auto=format 1200w,
                          https://cdn.sanity.io/images/33u1mixi/production/39760c243eb79af4cffe8658b5a6870a111879ca-72x91.svg?w=1920&amp;q=90&amp;fit=clip&amp;auto=format 1920w,
                          https://cdn.sanity.io/images/33u1mixi/production/39760c243eb79af4cffe8658b5a6870a111879ca-72x91.svg?w=2048&amp;q=90&amp;fit=clip&amp;auto=format 2048w,
                          https://cdn.sanity.io/images/33u1mixi/production/39760c243eb79af4cffe8658b5a6870a111879ca-72x91.svg?w=3840&amp;q=90&amp;fit=clip&amp;auto=format 3840w
                        "
                      ...
                      <div class="grid grid-cols-1 md:grid-cols-2">
                        <div
                          ...
                          <div class="flex-grow !text-dark-content">
                            <p class="text-base leading-normal font-regular undefined pb-8 pt-4 text-sm">
                              Ensuring your data
                              is protected is
                              critical to
                              Diligent. Learn how
        ...
        <!-- <div class="w-full border-t-8 border-brand-primary bg-brand-dim px-4 py-16">
          <div class="container mx-auto">
            <div class="mb-24 flex flex-col justify-between text-dark-content lg:flex-row lg:text-base">
              <div class="col-span-2 mb-8 lg:col-span-1 lg:mb-0">
                <img alt="Diligent" loading="lazy" width="151" height="42" decoding="async" data-nimg="1"
                  style="color: transparent" srcset="
                    /_next/image?url=%2Flogo%2Fdiligent_logo_reversed_rgb.svg&amp;w=256&amp;q=75 1x,
                    /_next/image?url=%2Flogo%2Fdiligent_logo_reversed_rgb.svg&amp;w=384&amp;q=75 2x
                  " src="_next/image0be8.svg?url=%2Flogo%2Fdiligent_logo_reversed_rgb.svg&amp;w=384&amp;q=75" />
              </div>
              <div class="grid grid-cols-1 gap-4 text-sm lg:grid-cols-footer-layout lg:gap-16">
                <div
                  class="pointer-events-auto relative z-10 overflow-hidden border-b-[1px] border-brand-gray-6 lg:border-0">
                  <h3 class="mb-1 flex items-center justify-between text-base font-semibold lg:text-xl">
                    <span class="hidden">Solutions</span><button
                      ...
                      <span>Solutions</span><span class="lg:hidden">
                        <div class="block">
                          <svg version="1.1" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"
                            preserveAspectRatio="xMidYMid" stroke-width="10" stroke-linecap="round"
                  ...
                  <ul
                    class="left-0 top-full -z-10 flex w-full list-none flex-col gap-5 overflow-hidden pb-4 pt-3 will-change-transform lg:mb-0 invisible absolute -translate-y-24 opacity-0 lg:visible lg:static lg:transform-none lg:opacity-100 lg:transition-none">
                    <li class="mb-2 text-dark-content">
                      <a href="solutions/board-and-leadership-collaboration.html"
                        class="cursor-pointer font-normal text-dark-title hover:text-dark-title hover:underline text-base relative flex items-center">Board
                        Management</a>
                    </li>
                    <li class="mb-2 text-dark-content">
                      <a href="solutions/enterprise-risk-management.html"
                        class="cursor-pointer font-normal text-dark-title hover:text-dark-title hover:underline text-base relative flex items-center">Enterprise
                        Risk Management</a>
                    </li>
                    <li class="mb-2 text-dark-content">
                      <a href="solutions/audit-management.html"
                        class="cursor-pointer font-normal text-dark-title hover:text-dark-title hover:underline text-base relative flex items-center">Audit
                        Management</a>
                    </li>
                    <li class="mb-2 text-dark-content">
                      <a href="solutions/market-intelligence.html"
                        class="cursor-pointer font-normal text-dark-title hover:text-dark-title hover:underline text-base relative flex items-center">Market
                        Intelligence</a>
                    </li>
                  </ul>
                </div>
                <div
                  class="pointer-events-auto relative z-10 overflow-hidden border-b-[1px] border-brand-gray-6 lg:border-0">
                  <h3 class="mb-1 flex items-center justify-between text-base font-semibold lg:text-xl">
                    <span class="hidden">Resources</span><button
                      class="relative z-20 m-0 flex w-full cursor-pointer select-none items-center justify-between py-2 font-normal text-dark-title">
                      <span>Resources</span><span class="lg:hidden">
                        <div class="block">
                          <svg version="1.1" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"
                            preserveAspectRatio="xMidYMid" stroke-width="10" stroke-linecap="round"
                            class="h-4 w-4 transform stroke-dark-title transition-transform duration-300 undefined">
                  ...
                  <ul
                    ...
                    <li class="mb-2 text-dark-content">
                      <a href="resources/blog.html"
                        class="cursor-pointer font-normal text-dark-title hover:text-dark-title hover:underline text-base relative flex items-center">Blog</a>
                    </li>
                    <li class="mb-2 text-dark-content">
                      <a href="resources/research.html"
                        class="cursor-pointer font-normal text-dark-title hover:text-dark-title hover:underline text-base relative flex items-center">Research
                        &amp; Reports</a>
                    </li>
                    <li class="mb-2 text-dark-content">
                      <a href="resources/podcasts.html"
                        class="cursor-pointer font-normal text-dark-title hover:text-dark-title hover:underline text-base relative flex items-center">Podcasts</a>
                    </li>
                    <li class="mb-2 text-dark-content">
                      <a href="resources/guides.html"
                        class="cursor-pointer font-normal text-dark-title hover:text-dark-title hover:underline text-base relative flex items-center">Guides</a>
                    </li>
                  </ul>
                </div>
                <div
                  class="pointer-events-auto relative z-10 overflow-hidden border-b-[1px] border-brand-gray-6 lg:border-0">
                  <h3 class="mb-1 flex items-center justify-between text-base font-semibold lg:text-xl">
                    <span class="hidden">Company</span><button
                      class="relative z-20 m-0 flex w-full cursor-pointer select-none items-center justify-between py-2 font-normal text-dark-title">
                      <span>Company</span><span class="lg:hidden">
                        <div class="block">
                          <svg version="1.1" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"
                            preserveAspectRatio="xMidYMid" stroke-width="10" stroke-linecap="round"
                            class="h-4 w-4 transform stroke-dark-title transition-transform duration-300 undefined">
                  ...
                  <ul
                    ...
                    <li class="mb-2 text-dark-content">
                      <a href="company/about-us.html"
                        class="cursor-pointer font-normal text-dark-title hover:text-dark-title hover:underline text-base relative flex items-center">About
                        Us</a>
                    </li>
                    <li class="mb-2 text-dark-content">
                      <a href="company/careers.html"
                        class="cursor-pointer font-normal text-dark-title hover:text-dark-title hover:underline text-base relative flex items-center">Careers</a>
                    </li>
                    <li class="mb-2 text-dark-content">
                      <a href="support.html"
                        class="cursor-pointer font-normal text-dark-title hover:text-dark-title hover:underline text-base relative flex items-center">Support</a>
                    </li>
                    <li class="mb-2 text-dark-content">
                      <a href="company/partners.html"
                        class="cursor-pointer font-normal text-dark-title hover:text-dark-title hover:underline text-base relative flex items-center">Partners</a>
                    </li>
                  </ul>
                </div>
              </div>
            </div>
            <div class="mb-8 rounded bg-[#141B26] px-6 py-8 text-dark-content">
              <div class="grid grid-cols-2 gap-16">
                <div class="col-span-2 flex flex-col lg:col-span-1">
                  <div class="mb-6 flex items-center gap-1">
                    <i class="material-symbols-outlined text-dark-icon text-2xl undefined" translate="no">security</i>
                    <h4 class="text-2xl text-dark-title">Your
                      Data Matters</h4>
                  </div>
                  <div class="text-sm">
                    At our core, transparency is key. We
                    prioritize your privacy
                    by providing clear information about
                    your rights and
                    facilitating their exercise. You&#x27;re
                    in control, with
                    the option to manage your preferences
                    and the extent of
                    information shared with us and our
                    partners.
                  </div>
                </div>
                <div class="col-span-2 grid grid-cols-[1fr_2fr] items-start gap-4 lg:col-span-1">
                  <div class="col-span-2 mb-8 flex flex-col justify-center gap-5 lg:col-span-1 lg:mb-0">
                    <a class="hover:text-brand-primary" href="legal/privacy.html">Privacy
                      Policy</a><a class="hover:text-brand-primary" href="legal/terms-of-use.html">Terms
                      of use</a><a class="hover:text-brand-primary" href="legal/cookie-policy.html">Cookie
                      Policy</a><a class="hover:text-brand-primary" href="legal/digital-services-act.html">Digital
                      Services Act</a>
                  </div>
                  <div class="col-span-2 flex flex-col justify-center gap-5 lg:col-span-1">
                    <a href="https://diligentlegal.results.highbond.com/survey_responses/9Wrc_yiuertX-uLJ4bJA/edit"
                      target="_blank" rel="noreferrer" class="hover:text-brand-primary">Your
                      Privacy Choices</a><a href="trust.html" target="_blank" rel="noreferrer"
                      class="hover:text-brand-primary">Trust
                      Center</a><a class="hover:text-brand-primary"
                      href="vulnerability-disclosure-program.html">Vulnerability
                      Disclosure Program</a><a class="hover:text-brand-primary" href="legal/modern-slavery.html">Modern
                      Slavery Statement</a>
                  </div>
                </div>
              </div>
            ...
            <div class="flex flex-col items-center justify-between gap-4 md:flex-row md:gap-0">
              <div class="flex gap-2 brightness-75">
                <a href="https://www.linkedin.com/company/diligent-board-member-services/" target="_blank"
                  rel="noreferrer"><svg viewBox="0 0 64 64" width="24" height="24">
                    <circle cx="32" cy="32" r="31" fill="#007fb1"></circle>
                    <path
                      d="M20.4,44h5.4V26.6h-5.4V44z M23.1,18c-1.7,0-3.1,1.4-3.1,3.1c0,1.7,1.4,3.1,3.1,3.1 c1.7,0,3.1-1.4,3.1-3.1C26.2,19.4,24.8,18,23.1,18z M39.5,26.2c-2.6,0-4.4,1.4-5.1,2.8h-0.1v-2.4h-5.2V44h5.4v-8.6 c0-2.3,0.4-4.5,3.2-4.5c2.8,0,2.8,2.6,2.8,4.6V44H46v-9.5C46,29.8,45,26.2,39.5,26.2z"
                      fill="white"></path>
                  </svg></a><a href="https://twitter.com/diligenthq" target="_blank" rel="noreferrer"><svg
                    viewBox="0 0 64 64" width="24" height="24">
                    <circle cx="32" cy="32" r="31" fill="#000000"></circle>
                    <path
                      d="M 41.116 18.375 h 4.962 l -10.8405 12.39 l 12.753 16.86 H 38.005 l -7.821 -10.2255 L 21.235 47.625 H 16.27 l 11.595 -13.2525 L 15.631 18.375 H 25.87 l 7.0695 9.3465 z m -1.7415 26.28 h 2.7495 L 24.376 21.189 H 21.4255 z"
                      fill="white"></path>
                  </svg></a><a href="https://www.facebook.com/DiligentCorporation" target="_blank" rel="noreferrer"><svg
                    viewBox="0 0 64 64" width="24" height="24">
              ...
              <div class="flex flex-col items-center gap-y-2 md:flex-row md:gap-x-2 md:gap-y-0">
                <div class="text-sm text-dark-content">
                  ©
                  2024
                  Diligent Corporation. All rights reserved.
                </div>
              </div>
            </div>
          </div>
