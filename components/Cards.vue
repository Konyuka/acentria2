                ...
                <div class="font-sans container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 py-0">
                    <div
                        ...
                        <div class="flex h-fit flex-col">
                            ...
                            <p
                                ...
                                Advanced tools for managing and assessing risk across insurance, reinsurance, and
                                investment
                                portfolios.
                            </p>
                        </div>
                    ...
                    <div
                        ...
                        <div class="flex h-fit flex-col">
                            ...
                            <p
                                class="text-base leading-normal font-regular text-light-content text-sm font-normal not-italic leading-normal">
                                Robust actuarial modeling and analytics capabilities for accurate forecasting and
                                financial
                                projections.
                            </p>
                        </div>
                    ...
                    <div
                        ...
                        <div class="flex h-fit flex-col">
                            ...
                            <p
                                class="text-base leading-normal font-regular text-light-content text-sm font-normal not-italic leading-normal">
                                Tools for optimizing investment portfolios, including performance tracking, asset
                                allocation,
                    ...
                    <div
                        ...
                        <div class="flex h-fit flex-col">
                            ...
                            <p
                                class="text-base leading-normal font-regular text-light-content text-sm font-normal not-italic leading-normal">
                                A suite of tech solutions designed to streamline operations, enhance data management,
                                and
