...
<template>
    <div>
        ...
        <div class="font-sans w-full border-t-8 border-black bg-gray-600 px-4 py-3">
                        ...
                        <ul
                            ...
                            <li v-for="link in item.items" class="button-animation mb-2 text-dark-content">
                                <NuxtLink :to="link.link"
                                    class="text-xs cursor-pointer font-normal text-dark-title hover:text-gray-100 relative flex items-center">
