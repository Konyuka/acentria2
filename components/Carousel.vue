<template>
    <div class="!overflow-x-hidden font-sans">
        <Carousel :autoplay="2000" :wrap-around="true">
            <Slide v-for="slide in slides" :key="slide" class="h-[75vh]">
                ...
                <div
                    ...
                    <h2 class="text-3xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-4 tracking-widest text-brand-primary" v-html="slide.title"></h2>
                    <p class="text-base sm:text-lg md:text-xl lg:text-2xl mb-8 mt-8">{{ slide.description }}</p>
                    <NuxtLink :to="slide.url"
                        class="button-animation z-[51] relative bg-brand-primary !hover:bg-black text-white font-medium py-3 px-6 sm:px-8 md:px-10 text-xl sm:text-sm rounded-sm mt-10">
