            ...
            <div class="col-span-2">
                <div class=" h-auto rounded-md shadow-xl p-5">
                    ...
                    <div class="grid grid-cols-3 gap-x-5 gap-y-10">
                        <NuxtLink :to="item.link" v-for="item in menuOptions" class="flex p-2 bg-black shadow-2xl rounded-md justify-center !text-center hover:scale-90 duration-700 ease-in-out">
