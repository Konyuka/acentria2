...
<template>
    <div class="font-sans text-white py-2" style="background-color: #f6f8fc">
            ...
            <div class="flex flex-col justify-center lg:basis-1/2">
                ...
                <div class="text-light-content pb-5 md:pb-6">
                    <p class="text-base leading-normal font-regular text-light-content !text-inherit mb-4">
                        ...
                        and
                        seize opportunities with confidence. Our team of experts is dedicated to providing you with
                        the insights and tools needed to make informed decisions, mitigate risks, and capitalize on
                        emerging trends. Partner with us to unlock your full potential and achieve sustainable success
            ...
            <div class="flex flex-col justify-center lg:basis-1/2">
                ...
                <div class="text-light-content pb-5 md:pb-6">
                    <p class="text-base leading-normal font-regular text-light-content !text-inherit mb-4">
                        ...
                        complex challenges and capitalize on emerging opportunities. By leveraging our expertise, you
                        can improve efficiency, reduce risks, and drive sustainable growth. Partner with us to stay
                        ahead in a rapidly evolving market and achieve your strategic objectives with confidence.
                    </p>
                </div>
            </div>
        </div>
