                ...
                <div
                    ...
                    <div v-for="tier in pricing.tiers" :key="tier.id"
                        ...
                        <a :href="tier.href" :aria-describedby="tier.id"
                            :class="[tier.mostPopular ? 'bg-brand-primary text-white shadow-sm hover:bg-indigo-500' : 'text-brand-primary ring-1 ring-inset ring-indigo-200 hover:ring-indigo-300', 'mt-6 block rounded-md px-3 py-2 text-center text-sm font-semibold leading-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-primary']">Buy
                            plan</a>
                ...
                <div class="mt-16 flex justify-center">
                    <p
                        ...
                        <span class="hidden md:inline">Transistor saves up to $40,000 per year, per employee by working
                            with us.</span>
                        <a href="#" class="font-semibold text-brand-primary"><span class="absolute inset-0"
