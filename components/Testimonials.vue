...
<template>
    <div class="font-sans relative isolate bg-white mb-3">
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div
                class="mx-auto mt-2 grid max-w-2xl grid-cols-1 grid-rows-1 gap-8 text-sm leading-6 text-gray-900 sm:mt-10 sm:grid-cols-2 xl:mx-0 xl:max-w-none xl:grid-flow-col xl:grid-cols-4">
