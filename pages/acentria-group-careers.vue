            ...
            <div class="container mx-auto">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                                    <div class="flex flex-col gap-2">
                                        ...
                                        <p class="content">
                                            ...
                                            partners have deepened, and we remain focused on doing business the right
                                            way—sustainably and with integrity.
                                            We are committed to providing incremental value to our customers and
                                            employees, ensuring that every step we take is aligned with our core
                                            principles of <b>Empowerment</b>, <b>Innovation</b>, and <b>Prosperity</b>.
                                            These
                                            values
                                            guide
                            ...
                            <div class="container max-w-6xl mx-auto">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                                    ...
                                    <div class="relative py-4">
                                        <NuxtImg alt="Image of growth" loading="lazy" decoding="async"
                                            src="/img/Professionals and Business Service.JPG"
                                    ...
                                    <div class="flex flex-col gap-2">
                                        ...
                                        <p class="content">
                                            ...
                                            at the core of our actions, staying energized, passionate, and focused on
                                            executing this vision.
                                            <br><br>
                                            This mindset is a fundamental part of Acentria Group’s DNA, fueling our
                                            continuous growth and the success of our clients, partners, and employees.
                                        </p>
                                    </div>
                    ...
                    <div class="container mx-auto flex px-4 lg:flex-row-reverse flex-col my-8 lg:my-4 lg:gap-16">
                        ...
                        <div class="flex flex-col justify-center lg:basis-1/2">
                            ...
                            <p class="text-sm leading-normal mb-4">
                                Working at Acentria is an enriching journey to growth and prosperity. We have numerous
                        ...
                        <div class="py-10">
                            ...
                            <div class="mt-5 grid grid-cols-1 gap-x-2 gap-y-4 lg:grid-cols-5">
                                <NuxtLink :to="member.link" v-for="member in careerPath" :key="member.name"
                                    class="group button-animation sm:flex lg:block bg-gray-50 px-5 py-2 rounded-xs border-b-2 border-brand-primary">
                ...
                <div class="mt-10">
                    ...
                    <div class="relative isolate overflow-hidden bg-black py-14 font-sans">
                        <NuxtImg src="/img/tornado.png" alt=""
                                        ...
                                        <div class="relative z-10 grid gap-2 bg-brand-white px-4 py-2">
                                            <section class="grid items-start justify-start gap-y-3">
                                                <div class="relative flex flex-col gap-y-1">
                                                    <label class="text-xs text-brand-primary capitalize">{{ news.tag
                                                        }}</label>
