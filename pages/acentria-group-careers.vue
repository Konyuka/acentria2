                    ...
                    <div class="overflow-hidden bg-white py-24 sm:py-32">
                        <div class="mx-auto max-w-7xl md:px-6 lg:px-8">
                            <div class="grid grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:grid-cols-2 lg:items-start">
                                <div class="px-6 lg:px-0 lg:pr-4 lg:pt-4">
                                    <div class="mx-auto max-w-2xl lg:mx-0 lg:max-w-lg">
                                        <div class="font-sans mt-6">
                                            <h2 id=""
                                                class="font-sans text-2xl pb-4 md:pb-5 font-semibold md:text-3xl xl:text-3xl 2xl:text-4xl leading-tight text-light-title pb-4 sm:pb-4 md:!pb-4 lg:!pb-9 xl:!pb-9 xl:text-4xl 2xl:text-4xl">
                                                <span
                                                    class="text-brand-primary pb-0 sm:pb-4 md:!pb-4 lg:!pb-9 xl:!pb-9 xl:text-4xl 2xl:text-4xl">What
                                                    drives us</span> <br>
                                                at Acentria Group?
                                            </h2>
                                            <p
                                            ...
                                            <h5 id=""
                                                class="text-sm pb-3 md:pb-4 font-semibold md:text-xl xl:text-xl 2xl:text-2xl leading-tight text-brand-primary !text-lg">
                                                Our values
                                            </h5>

                                            <p v-for="value in values" :key="value.name"
                                                class="text-base leading-normal font-regular text-light-content leading-2 mb-4">
                                ...
                                <div class="h-full min-h-[25rem] sm:min-h-[40rem] sm:px-6 lg:px-0">
                                    <div
                                        class="bg-brand-primary relative isolate h-full overflow-hidden px-6 pt-8 sm:mx-auto sm:max-w-2xl sm:rounded-xl sm:pl-16 sm:pr-0 sm:pt-16 lg:mx-0 lg:max-w-none">
                                        ...
                                        <div class="absolute bottom-0 right-0 h-[90%] w-[90%]">
                                            <img alt="image" fetchPriority="high" decoding="async" data-nimg="fill"
                                                class="rounded-tl-xl" style="
                                position: absolute;
                                height: 100%;
                                width: 100%;
                                left: 0;
                                ...
                                color: transparent;
                              " sizes="100vw"
                                                src="https://images.pexels.com/photos/6457511/pexels-photo-6457511.jpeg?auto=compress&cs=tinysrgb&w=600" />
                                        </div>
                                        <div class="pointer-events-none absolute inset-0 ring-1 ring-inset ring-black/10 sm:rounded-xl"
                                            aria-hidden="true"></div>
                                    </div>
                                </div>
                            </div>
