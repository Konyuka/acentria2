...
const benefits = ref([
    ...
    },
    {
        ...
        description: 'Applying for our critical illness insurance is simple and straightforward. You can get a quote, compare plans, and apply online in just a few minutes.',
    },
    {
    ...
    <section class="bg-white">
        ...
        <div class="container mx-auto py-10">
            ...
            <p class="mt-6 text-xs leading-normal">
                A critical illness diagnosis can be emotionally and financially overwhelming. Our critical illness insurance provides a safety net to help you manage the financial impact of severe health conditions, allowing you to focus on your recovery without added stress.
            </p>
        </div>
        ...
        <div class="py-2">
            <section class="relative py-1">
                ...
                <div class="container py-10 mt-5">
                    ...
                    <div class="my-5">
                        <p class="text-sm leading-normal">
                            Protect yourself and your loved ones with our comprehensive critical illness insurance. Get a quote today and take the first step towards financial security and peace of mind.
                        </p>
                    </div>
