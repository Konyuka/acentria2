                                        ...
                                        <div
                                            ...
                                            <div class="w-full">
                                                <p
                                                    ...
                                                    management. Our cutting-edge
                                                    technology ensures that we deliver innovative and efficient
                                                    solutions tailored to meet the
                                                    unique needs of our clients. Trust us to safeguard your future with
                                ...
                                <div
                                    ...
                                    <div class="flex flex-col justify-center lg:basis-1/2">
                                        ...
                                        <div class="text-light-content pb-5 md:pb-6">
                                            <p
                                                class="text-sm leading-normal font-regular text-light-content !text-inherit mb-4">
                                ...
                                <div
                                    ...
                                    <div class="flex flex-col justify-center lg:basis-1/2">
                                        ...
                                        <div class="text-light-content pb-5 md:pb-6">
                                            <p
                                                class="text-sm leading-normal font-regular text-light-content !text-inherit mb-4">
                                                To continuously Empower our clients and communities through innovative
                                                solutions, which
                                                ...
                                                clients through igniting
                                                innovative thinking in offering the best solutions to enhance
                                                prosperity.
                                            </p>
                                        </div>
                                    </div>
                                            ...
                                            <div
                                                ...
                                                <div class="flex h-fit flex-col"><i
                                                    ...
                                                    <div class="grid grid-cols-2 gap-1 text-black text-xs">
                                                        <p><i class="fas fa-check mr-1 text-brand-primary"></i>
                                                            Integrity</p>
                                                        <p><i class="fas fa-check mr-1 text-brand-primary"></i>
                                                            Excellence</p>
                                                        <p><i class="fas fa-check mr-1 text-brand-primary"></i>
                                                            Innovative</p>
                                                        <p><i class="fas fa-check mr-1 text-brand-primary"></i> Teamwork
                                                        </p>
                                                        <p><i class="fas fa-check mr-1 text-brand-primary"></i>
                                                            Relationships</p>
                                                        <p><i class="fas fa-check mr-1 text-brand-primary"></i> Growth
                                                            &amp; Prosperity</p>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="container px-4">
                                    <div class=" max-w-6xl justify-between content-center">
                                        ...
                                        <p
                                            ...
                                            At Acentria, we believe we have a responsibility to not only our customers
                                    ...
                                    <div class="font-sans grid grid-cols-1 md:grid-cols-4 lg:grid-cols-4 gap-4 py-0">
                                        ...
                                        <div v-for="item in commitments"
                                            ...
                                            <div class="flex h-fit flex-col">
                                                <i :class="item.icon"
                                                    class="text-black text-4xl pb-4 group-hover:text-brand-primary"
                                                    translate="no"></i>
                                                <h3
                                                    class="text-lg text-brand-primary font-semibold flex justify-left group-hover:text-black">
                                                    {{ item.name
                            ...
                            <div class="relative mx-auto max-w-2xl lg:mx-0">
                                ...
                                <figure>
                                    <blockquote class="mt-6 text-xs font-semibold text-white sm:text-xl sm:leading-5 ">
                                        <p>
                                            Our initiatives focus on reducing our environmental impact, promoting
                                            ethical
                                            business practices,
                                            and contributing positively to the communities we serve. We believe in
                                            creating
                                            long-term value
