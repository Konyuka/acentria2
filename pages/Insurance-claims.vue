        ...
        <div class="bg-white w-full h-full">
            <div class="container py-5 max-w-6xl mx-auto font-sans text-black mt-2">
                ...
                <p class="text-xs leading-normal">
                    ...
                    your insurance needs. Thank you for choosing Acentria Insurance. We look forward to serving you.
                </p>
                <div class="mt-5">
                    <a href="/meet-the-team"
                        class="button-animation bg-black hover:bg-brand-primary text-white font-medium py-1 px-12 text-sm rounded-sm mt-10">
                        Report or View a Claim <i class="fas fa-arrow-right text-primary ml-2"></i>
                    </a>
                </div>
            </div>
        </div>
                        ...
                        <div class="mt-5 grid grid-cols-1 gap-x-2 gap-y-4 lg:grid-cols-3">
                            <NuxtLink :to="member.link" v-for="member in joinAsMembers" :key="member.name"
                                ...
                                <div class="mt-4 sm:ml-6 sm:mt-0 lg:ml-0 lg:mt-6">
                                    <h3 class="text-lg text-brand-primary flex justify-center">{{ member.name }}</h3>
                                    <p class="mt-2 text-md text-gray-500">{{ member.description }}</p>
                                </div>
