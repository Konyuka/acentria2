...
const specials = ref([
    ...
    },
    {
        ...
        items: [
            'Political Violence including Riot Strike or Civil Commotion',
    ...
    {
        name:'Casualty and Liability Classes',
        items:[
